...
class ConnectionManager
{
	...
	protected function _setConnectionsData()
	{
		...
		$data["dbType"] = 0;
		$data["connId"] = "Tables";
		$data["connName"] = "Jobs at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;Jobs;;1"; //currently unused
		
		$this->_connectionsIdByName["Jobs at localhost"] = "Tables";
		...
		$data["connInfo"][2] = "";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "Jobs";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=Jobs;OPTION=3";
	...
	protected function _setTablesConnectionIds()
	{
		...
		$connectionsIds["jobsjobs"] = "Tables";
		$connectionsIds["jobsjobtype"] = "Tables";
		$connectionsIds["jobsstate"] = "Tables";
		$connectionsIds["jobsusers"] = "Tables";
