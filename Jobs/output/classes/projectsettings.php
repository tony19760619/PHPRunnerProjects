...
class ProjectSettings
{
	...
	*/
	...
	{
		return new ProjectSettings("jobsusers", PAGE_LIST);
	}
...
{	
	...
	if(!$shortTName)
		return false;
	if("jobsjobs" == $shortTName) 
		return "jobsjobs";
	if("jobsjobtype" == $shortTName) 
		return "jobsjobtype";
	if("jobsstate" == $shortTName) 
		return "jobsstate";
	if("jobsusers" == $shortTName) 
		return "jobsusers";
}
