...
require_once("include/jobsjobs_variables.php");
...
$layout = new TLayout("Jobsview", "PurificGreen", "MobileGreen");
$layout->version = 2;
...
$layout->containers["fields"][] = array("name"=>"", 
	"block"=>"", "substyle"=>2  );
...
$page_layouts["jobsjobs_view"] = $layout;
