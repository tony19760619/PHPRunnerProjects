...
function UsersTableName()
{
	...
	return $connection->addTableWrappers("jobsusers");
}
...
class tDAL
{
	var $tblTables__jobsjobs;
	var $tblTables__jobsjobtype;
	var $tblTables__jobsstate;
	var $tblTables__jobsusers;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "jobsjobs", "varname" => "Tables__jobsjobs", "altvarname" => "jobsjobs", "connId" => "Tables", "schema" => "", "connName" => "Jobs at localhost");
		$this->lstTables[] = array("name" => "jobsjobtype", "varname" => "Tables__jobsjobtype", "altvarname" => "jobsjobtype", "connId" => "Tables", "schema" => "", "connName" => "Jobs at localhost");
		$this->lstTables[] = array("name" => "jobsstate", "varname" => "Tables__jobsstate", "altvarname" => "jobsstate", "connId" => "Tables", "schema" => "", "connName" => "Jobs at localhost");
		$this->lstTables[] = array("name" => "jobsusers", "varname" => "Tables__jobsusers", "altvarname" => "jobsusers", "connId" => "Tables", "schema" => "", "connName" => "Jobs at localhost");
	}
