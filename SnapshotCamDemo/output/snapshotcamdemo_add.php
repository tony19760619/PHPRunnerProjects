...
require_once("include/snapshotcamdemo_variables.php");
...
$layout = new TLayout("add_basic_center", "RoundedOffice", "MobileOffice");
$layout->version = 2;
...
$layout->containers["fields"][] = array("name"=>"addfields_simple",
	"block"=>"", "substyle"=>1  );
...
$page_layouts["snapshotcamdemo_add"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "snapshotcamdemo_list";
...
$page_layouts["snapshotcamdemo_list"] = $layout;
