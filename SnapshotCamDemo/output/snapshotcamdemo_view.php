...
$layout = new TLayout("view_bootstrap_2col", "RoundedOffice", "MobileOffice");
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "snapshotcamdemo_view";
...
$page_layouts["snapshotcamdemo_view"] = $layout;
