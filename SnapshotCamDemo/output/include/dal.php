...
class tDAL
{
	var $tbltbs_onlinecoza_tbs_at_localhost__snapshotcamdemo2;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "snapshotcamdemo2", "varname" => "tbs_onlinecoza_tbs_at_localhost__snapshotcamdemo2", "altvarname" => "snapshotcamdemo2", "connId" => "tbs_onlinecoza_tbs_at_localhost", "schema" => "", "connName" => "tbs-onlinecoza_tbs at localhost");
	}
