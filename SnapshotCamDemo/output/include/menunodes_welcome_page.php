...
function getMenuNodes_welcome_page($menuNodesObject)
{
	...
	$menuNode["title"] = "SnapshotCamDemo";
	...
	$menuNode["type"] = "Leaf";
	$menuNode["table"] = "snapshotcamdemo2";
	$menuNode["style"] = "";
	$menuNode["params"] = "";
	$menuNode["parent"] = "1";
	$menuNode["nameType"] = "Text";
	...
	$menuNode["title"] = "Snapshotcamdemo2";

	$menuNode["comments"] = "Snapshotcamdemo description";
