...
class ConnectionManager
{
	...
	{
		return $this->byId( "tbs_onlinecoza_tbs_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "tbs_onlinecoza_tbs_at_localhost";
		$data["connName"] = "tbs-onlinecoza_tbs at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;tbs-o_snapshot;Yolanda!23;;tbs-onlinecoza_tbs;;1"; //currently unused
		
		$this->_connectionsIdByName["tbs-onlinecoza_tbs at localhost"] = "tbs_onlinecoza_tbs_at_localhost";
		
		$data["connInfo"] = array();
		$data["ODBCUID"] = "tbs-o_snapshot";
		$data["ODBCPWD"] = "Yolanda!23";
		$data["leftWrap"] = "`";
		$data["rightWrap"] = "`";
		...
		$data["connInfo"][1] = "tbs-o_snapshot";
		$data["connInfo"][2] = "Yolanda!23";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "tbs-onlinecoza_tbs";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=tbs-o_snapshot;Pwd=Yolanda!23;Database=tbs-onlinecoza_tbs;OPTION=3";
		// encription set
		...
		$connectionsData["tbs_onlinecoza_tbs_at_localhost"] = $data;
	...
	protected function _setTablesConnectionIds()
	{
		...
		$connectionsIds["snapshotcamdemo2"] = "tbs_onlinecoza_tbs_at_localhost";
