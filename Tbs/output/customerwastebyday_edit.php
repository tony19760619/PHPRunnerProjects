...
$page_layouts["customerwastebyday_edit"] = $layout;
...
if($inlineedit == EDIT_INLINE)
	$templatefile = GetTemplateName("customerwastebyday", "inline_edit");
else 
	$templatefile = GetTemplateName("customerwastebyday", "edit");
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	HeaderRedirect("customerwastebyday", $pageObject->getPageType(), $keyGetQ);
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton"
	.$id."\" onclick=\"window.location.href='".GetTableLink("customerwastebyday", "view", $viewlink)."'\"");
