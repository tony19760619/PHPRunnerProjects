...
$page_layouts["customerwaste_search"] = $layout;
...
$mode = SEARCH_SIMPLE;
$templatefile = GetTemplateName("customerwaste", "search");
...
$params['shortTableName'] = 'customerwaste';
...
if ($mode==SEARCH_SIMPLE)
{
	...
	else
	{
		...
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = $pageObject->pSet->getDefaultValue( "DateTime" );
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
		$firstFieldParams['not'] = false;
	}
