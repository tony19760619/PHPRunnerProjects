...
$page_layouts["RegisterPage_customer_export"] = $layout;
...
$pageObject->display(GetTemplateName("RegisterPage_customer", "export"));
...
// write header
	...
	{
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("RegisterPage_customer","Id")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("RegisterPage_customer","Name")).'</td>';	
	}
	else
	{
		echo "<td>".GetFieldLabel("RegisterPage_customer","Id")."</td>";
		echo "<td>".GetFieldLabel("RegisterPage_customer","Name")."</td>";
	}
	echo "</tr>";
