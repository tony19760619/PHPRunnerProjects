...
$pageObject->display(GetTemplateName("user", "export"));
...
// write header
	...
	{
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("user","Id")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("user","UserType")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("user","Username")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("user","Password")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("user","CustomerId")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("user","Name")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("user","Active")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("user","Email")).'</td>';	
	}
	else
	{
		echo "<td>".GetFieldLabel("user","Id")."</td>";
		echo "<td>".GetFieldLabel("user","UserType")."</td>";
		echo "<td>".GetFieldLabel("user","Username")."</td>";
		echo "<td>".GetFieldLabel("user","Password")."</td>";
		echo "<td>".GetFieldLabel("user","CustomerId")."</td>";
		echo "<td>".GetFieldLabel("user","Name")."</td>";
		echo "<td>".GetFieldLabel("user","Active")."</td>";
		echo "<td>".GetFieldLabel("user","Email")."</td>";
	}
	echo "</tr>";
