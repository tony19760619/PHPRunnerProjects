...
$page_layouts["waste_print"] = $layout;
...
//	WasteDescr - 
			$record["WasteDescr_value"] = $pageObject->showDBValue("WasteDescr", $data, $keylink);
			$record["WasteDescr_class"] = $pageObject->fieldClass("WasteDescr");
			if($col<$colsonpage)
...
$xt->assign("WasteDescr_fieldheadercolumn",true);
$xt->assign("WasteDescr_fieldheader",true);
$xt->assign("WasteDescr_class", $pageObject->fieldClass("WasteDescr"));
$xt->assign("WasteDescr_fieldcolumn",true);
$xt->assign("WasteDescr_fieldfootercolumn",true);
