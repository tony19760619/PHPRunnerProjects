...
$keys[] = AddFieldWrappers("CustomerId");
$keys[] = AddFieldWrappers("WasteId");
$keys_present=1;
...
$page_layouts["customerwastebyyear_import"] = $layout;
...
$pageObject->display(GetTemplateName("customerwastebyyear", "import"));
