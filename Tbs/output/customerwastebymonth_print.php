...
$layout = new TLayout("print", "RoundedWhite_label", "MobileWhite_label");
$layout->version = 2;
...
$page_layouts["customerwastebymonth_print"] = $layout;
...
$arr = array();
$arr['fName'] = "WasteId";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("WasteId");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "Year";
...
//	WasteId - 
			$record["WasteId_value"] = $pageObject->showDBValue("WasteId", $data, $keylink);
			$record["WasteId_class"] = $pageObject->fieldClass("WasteId");
//	Year - 
			$record["Year_value"] = $pageObject->showDBValue("Year", $data, $keylink);
			$record["Year_class"] = $pageObject->fieldClass("Year");
//	Month - 
			$record["Month_value"] = $pageObject->showDBValue("Month", $data, $keylink);
			$record["Month_class"] = $pageObject->fieldClass("Month");
//	Amount - Number
...
//	include proper masterprint.php code
	...
	$params = array("detailtable"=>"customerwastebymonth","keys"=>$masterkeys);
	$master = array();
	AssignFunction($master, "DisplayMasterTableInfoForPrint_customer", $params);
...
if($mastertable == "waste")
{
//	include proper masterprint.php code
	include("include/waste_masterprint.php");
	$masterkeys[] = @$_SESSION[$strTableName."_masterkey1"];
	$params = array("detailtable"=>"customerwastebymonth","keys"=>$masterkeys);
	$master = array();
	AssignFunction($master, "DisplayMasterTableInfoForPrint_waste", $params);
	$xt->assignbyref("showmasterfile",$master);
	$xt->assign("mastertable_block",true);
...
$layout->skinsparams["3"] = array("button"=>"button1");
	...
	$layout = GetPageLayout("waste", 'masterprint');
	if($layout)
	{
		$pageObject->AddCSSFile($layout->getCSSFiles(isRTL(), isMobile()));
	}	
...
$xt->assign("CustomerId_class", $pageObject->fieldClass("CustomerId"));
$xt->assign("CustomerId_fieldcolumn",true);
$xt->assign("CustomerId_fieldfootercolumn",true);
$xt->assign("WasteId_fieldheadercolumn",true);
$xt->assign("WasteId_fieldheader",true);
$xt->assign("WasteId_class", $pageObject->fieldClass("WasteId"));
$xt->assign("WasteId_fieldcolumn",true);
$xt->assign("WasteId_fieldfootercolumn",true);
$xt->assign("Year_fieldheadercolumn",true);
$xt->assign("Year_fieldheader",true);
$xt->assign("Year_class", $pageObject->fieldClass("Year"));
$xt->assign("Year_fieldcolumn",true);
$xt->assign("Year_fieldfootercolumn",true);
$xt->assign("Month_fieldheadercolumn",true);
$xt->assign("Month_fieldheader",true);
$xt->assign("Month_class", $pageObject->fieldClass("Month"));
$xt->assign("Month_fieldcolumn",true);
$xt->assign("Month_fieldfootercolumn",true);
$xt->assign("Amount_fieldheadercolumn",true);
$xt->assign("Amount_fieldheader",true);
$xt->assign("Amount_class", $pageObject->fieldClass("Amount"));
