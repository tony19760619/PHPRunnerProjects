...
$page_layouts["customerwastebyyear_view"] = $layout;
...
if (!sizeof($data)) 
{
	HeaderRedirect("customerwastebyyear", "list", "a=return");
	exit();
}
...
while($data)
{
	...
	if( $mainTableOwnerID == "WasteId" )
		$ownerIdValue = $value;
	$xt->assign("WasteId_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='".GetTableLink("customerwastebyyear", "edit", $editlink)."'\"");
