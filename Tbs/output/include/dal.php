...
class tDAL
{
	var $customer;
	var $customerwaste;
	var $customerwastebyday;
	var $customerwastebymonth;
	var $customerwastebyweek;
	var $customerwastebyyear;
	var $tbs_locking;
	var $tbs_uggroups;
	var $tbs_ugmembers;
	var $tbs_ugrights;
	...
	function FillTablesList()
	{
	  ...
	  $this->lstTables[]=array("name"=>"customerwaste","varname"=>"customerwaste");
	  $this->lstTables[]=array("name"=>"customerwastebyday","varname"=>"customerwastebyday");
	  $this->lstTables[]=array("name"=>"customerwastebymonth","varname"=>"customerwastebymonth");
	  $this->lstTables[]=array("name"=>"customerwastebyweek","varname"=>"customerwastebyweek");
	  $this->lstTables[]=array("name"=>"customerwastebyyear","varname"=>"customerwastebyyear");
	  $this->lstTables[]=array("name"=>"tbs_locking","varname"=>"tbs_locking");
	  $this->lstTables[]=array("name"=>"tbs_uggroups","varname"=>"tbs_uggroups");
	  $this->lstTables[]=array("name"=>"tbs_ugmembers","varname"=>"tbs_ugmembers");
	  $this->lstTables[]=array("name"=>"tbs_ugrights","varname"=>"tbs_ugrights");
	  $this->lstTables[]=array("name"=>"user","varname"=>"user");
	  $this->lstTables[]=array("name"=>"waste","varname"=>"waste");
	}
