...
$page_layouts["customerwastebymonth_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='".GetTableLink("customerwastebymonth", "edit", $editlink)."'\"");
