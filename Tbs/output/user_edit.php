...
if($inlineedit == EDIT_INLINE)
	$templatefile = GetTemplateName("user", "inline_edit");
else 
	$templatefile = GetTemplateName("user", "edit");
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	HeaderRedirect("user", $pageObject->getPageType(), $keyGetQ);
...
if(!$data)
{
	...
	{
		HeaderRedirect("user", "list", "a=return");
		exit();
	}
	else
		$data = array();
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton"
	.$id."\" onclick=\"window.location.href='".GetTableLink("user", "view", $viewlink)."'\"");
