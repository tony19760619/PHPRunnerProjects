...
while($data)
{
	...
	if( $mainTableOwnerID == "UserType" )
		$ownerIdValue = $value;
	$xt->assign("UserType_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='".GetTableLink("user", "edit", $editlink)."'\"");
