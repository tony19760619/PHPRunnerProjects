...
$page_layouts["customerwaste_export"] = $layout;
...
$pageObject->display(GetTemplateName("customerwaste", "export"));
...
function ExportToXML($rs, $nPageSize, $strTableName, $eventObj, $cipherer, $pageObject)
{
	...
	while((!$nPageSize || $i<$nPageSize) && $row)
	{
		$values = array();
			...
			$values["DateTime"] = $pageObject->getExportValue("DateTime", $row);
...
// write data rows
	...
	while((!$nPageSize || $iNumberOfRows < $nPageSize) && $row)
	{
		$values = array();
			...
			$values["DateTime"] = $pageObject->getViewControl("DateTime")->getExportValue($row, "");
...
// write header
	...
	{
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("customerwaste","Id")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("customerwaste","CustomerId")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("customerwaste","WasteId")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("customerwaste","DateTime")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("customerwaste","Amount")).'</td>';	
	}
	else
	{
		echo "<td>".GetFieldLabel("customerwaste","Id")."</td>";
		echo "<td>".GetFieldLabel("customerwaste","CustomerId")."</td>";
		echo "<td>".GetFieldLabel("customerwaste","WasteId")."</td>";
		echo "<td>".GetFieldLabel("customerwaste","DateTime")."</td>";
		echo "<td>".GetFieldLabel("customerwaste","Amount")."</td>";
	}
	echo "</tr>";
