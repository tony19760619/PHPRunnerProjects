...
$arr = array();
$arr['fName'] = "UserType";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("UserType");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "Username";
...
//	UserType - 
			$record["UserType_value"] = $pageObject->showDBValue("UserType", $data, $keylink);
			$record["UserType_class"] = $pageObject->fieldClass("UserType");
//	Username - 
...
//	include proper masterprint.php code
	...
	$params = array("detailtable"=>"user","keys"=>$masterkeys);
	$master = array();
...
$xt->assign("UserType_fieldheadercolumn",true);
$xt->assign("UserType_fieldheader",true);
$xt->assign("UserType_class", $pageObject->fieldClass("UserType"));
$xt->assign("UserType_fieldcolumn",true);
$xt->assign("UserType_fieldfootercolumn",true);
$xt->assign("Username_fieldheadercolumn",true);
$xt->assign("Username_fieldheader",true);
$xt->assign("Username_class", $pageObject->fieldClass("Username"));
...
$xt->assign("Password_class", $pageObject->fieldClass("Password"));
...
$xt->assign("Name_class", $pageObject->fieldClass("Name"));
...
$xt->assign("Active_class", $pageObject->fieldClass("Active"));
...
$xt->assign("Email_class", $pageObject->fieldClass("Email"));
