...
$page_layouts["customerwaste_print"] = $layout;
...
//	DateTime - Short Date
			$record["DateTime_value"] = $pageObject->showDBValue("DateTime", $data, $keylink);
			$record["DateTime_class"] = $pageObject->fieldClass("DateTime");
//	Amount - Number
...
//	include proper masterprint.php code
	...
	$params = array("detailtable"=>"customerwaste","keys"=>$masterkeys);
	$master = array();
...
$xt->assign("DateTime_class", $pageObject->fieldClass("DateTime"));
