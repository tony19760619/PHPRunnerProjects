...
$page_layouts["RegisterPage_customer_edit"] = $layout;
...
if($inlineedit == EDIT_INLINE)
	$templatefile = GetTemplateName("RegisterPage_customer", "inline_edit");
else 
	$templatefile = GetTemplateName("RegisterPage_customer", "edit");
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	HeaderRedirect("RegisterPage_customer", $pageObject->getPageType(), $keyGetQ);
...
if(!$data)
{
	...
	{
		HeaderRedirect("RegisterPage_customer", "list", "a=return");
		exit();
	}
	else
		$data = array();
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton"
	.$id."\" onclick=\"window.location.href='".GetTableLink("RegisterPage_customer", "view", $viewlink)."'\"");
