...
$page_layouts["customerwastebyweek_print"] = $layout;
...
//	Week - 
			$record["Week_value"] = $pageObject->showDBValue("Week", $data, $keylink);
			$record["Week_class"] = $pageObject->fieldClass("Week");
//	Amount - Number
...
//	include proper masterprint.php code
	...
	$params = array("detailtable"=>"customerwastebyweek","keys"=>$masterkeys);
	$master = array();
...
$xt->assign("Week_fieldheadercolumn",true);
$xt->assign("Week_fieldheader",true);
$xt->assign("Week_class", $pageObject->fieldClass("Week"));
$xt->assign("Week_fieldcolumn",true);
$xt->assign("Week_fieldfootercolumn",true);
