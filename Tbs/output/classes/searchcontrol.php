...
{	
	...
	function SearchControl($id, $tName = '', &$searchClauseObj, &$pageObj)
	{
		...
		$this->controlsContainer->searchPanelActivated = true;
	}
	...
	{
		return $this->getControl($fName)->getSearchOptions($selOpt, $not, false);
	}
	 ...
	 * @return String
	 */
	function getCtrlSearchType($fName, $recId, $fieldNum=0, $selOpt, $not, $flexible) 
	{
		...
		$searchtype.= $this->getCtrlSearchTypeOptions($fName, $selOpt, $not, $flexible);
