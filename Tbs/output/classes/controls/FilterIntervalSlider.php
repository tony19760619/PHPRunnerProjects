...
class FilterIntervalSlider extends FilterControl
{
	...
	protected function buildSQL()
	{
		...
		$sqlHead = "SELECT MIN(".$dbfName.") as sliderMin, MAX(".$dbfName.") as sliderMax";	
	...
	{
		$pageObject->AddJSFile("include/jquery-ui/jquery-ui-1.10.2.custom.min.js");
		$pageObject->AddCSSFile("include/jquery-ui/smoothness/jquery-ui-1.10.2.custom.min.css");
	}
