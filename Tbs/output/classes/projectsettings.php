...
function GetTableURL($table = "")
{
	...
	if("customer" == $table) 
		return "customer";
	if("customerwaste" == $table) 
		return "customerwaste";
	if("customerwastebyday" == $table) 
		return "customerwastebyday";
	if("customerwastebymonth" == $table) 
		return "customerwastebymonth";
	if("customerwastebyweek" == $table) 
		return "customerwastebyweek";
	if("customerwastebyyear" == $table) 
		return "customerwastebyyear";
	if("waste" == $table) 
		return "waste";
	if("user" == $table) 
		return "user";
	...
	if("admin_users" == $table) 
		return "admin_users";
	if("RegisterPage_customer" == $table) 
		return "RegisterPage_customer";
...
{	
	...
	if("customer" == $shortTName) 
		return "customer";
	if("customerwaste" == $shortTName) 
		return "customerwaste";
	if("customerwastebyday" == $shortTName) 
		return "customerwastebyday";
	if("customerwastebymonth" == $shortTName) 
		return "customerwastebymonth";
	if("customerwastebyweek" == $shortTName) 
		return "customerwastebyweek";
	if("customerwastebyyear" == $shortTName) 
		return "customerwastebyyear";
	if("waste" == $shortTName) 
		return "waste";
	if("user" == $shortTName) 
	...
	if("admin_users" == $shortTName) 
		return "admin_users";
	if("RegisterPage_customer" == $shortTName) 
		return "RegisterPage_customer";
}
