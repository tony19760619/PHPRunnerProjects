...
$page_layouts["customerwastebyweek_export"] = $layout;
...
$pageObject->display(GetTemplateName("customerwastebyweek", "export"));
...
function ExportToXML($rs, $nPageSize, $strTableName, $eventObj, $cipherer, $pageObject)
{
	...
	while((!$nPageSize || $i<$nPageSize) && $row)
	{
		$values = array();
			...
			$values["Week"] = $pageObject->getExportValue("Week", $row);
...
// write data rows
	...
	while((!$nPageSize || $iNumberOfRows < $nPageSize) && $row)
	{
		$values = array();
			...
			$values["Week"] = $pageObject->getViewControl("Week")->getExportValue($row, "");
		...
		if ($eventRes)
		{
			...
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["Week"]).'"';
			if($outstr!="")
				$outstr.=",";
...
// write header
	...
	{
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("customerwastebyweek","Id")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("customerwastebyweek","CustomerId")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("customerwastebyweek","WasteId")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("customerwastebyweek","Year")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("customerwastebyweek","Week")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("customerwastebyweek","Amount")).'</td>';	
	}
	else
	{
		echo "<td>".GetFieldLabel("customerwastebyweek","Id")."</td>";
		echo "<td>".GetFieldLabel("customerwastebyweek","CustomerId")."</td>";
		echo "<td>".GetFieldLabel("customerwastebyweek","WasteId")."</td>";
		echo "<td>".GetFieldLabel("customerwastebyweek","Year")."</td>";
		echo "<td>".GetFieldLabel("customerwastebyweek","Week")."</td>";
		echo "<td>".GetFieldLabel("customerwastebyweek","Amount")."</td>";
	}
	echo "</tr>";
