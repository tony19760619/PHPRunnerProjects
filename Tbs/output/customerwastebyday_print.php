...
$page_layouts["customerwastebyday_print"] = $layout;
...
//	include proper masterprint.php code
	...
	$params = array("detailtable"=>"customerwastebyday","keys"=>$masterkeys);
	$master = array();
...
$xt->assign("Date_class", $pageObject->fieldClass("Date"));
