...
$page_layouts["customerwastebyday_view"] = $layout;
...
if (!sizeof($data)) 
{
	HeaderRedirect("customerwastebyday", "list", "a=return");
	exit();
}
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='".GetTableLink("customerwastebyday", "edit", $editlink)."'\"");
