...
if($inlineedit == EDIT_INLINE)
	$templatefile = GetTemplateName("customer", "inline_edit");
else 
	$templatefile = GetTemplateName("customer", "edit");
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	HeaderRedirect("customer", $pageObject->getPageType(), $keyGetQ);
...
if(!$data)
{
	...
	{
		HeaderRedirect("customer", "list", "a=return");
		exit();
	}
	else
		$data = array();
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton"
	.$id."\" onclick=\"window.location.href='".GetTableLink("customer", "view", $viewlink)."'\"");
