...
$page_layouts["RegisterPage_customer_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='".GetTableLink("RegisterPage_customer", "edit", $editlink)."'\"");
