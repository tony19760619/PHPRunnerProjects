...
$page_layouts["customerwastebyyear_export"] = $layout;
...
$pageObject->display(GetTemplateName("customerwastebyyear", "export"));
...
// write header
	...
	{
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("customerwastebyyear","Id")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("customerwastebyyear","CustomerId")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("customerwastebyyear","WasteId")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("customerwastebyyear","Year")).'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel(GetFieldLabel("customerwastebyyear","Amount")).'</td>';	
	}
	else
	{
		echo "<td>".GetFieldLabel("customerwastebyyear","Id")."</td>";
		echo "<td>".GetFieldLabel("customerwastebyyear","CustomerId")."</td>";
		echo "<td>".GetFieldLabel("customerwastebyyear","WasteId")."</td>";
		echo "<td>".GetFieldLabel("customerwastebyyear","Year")."</td>";
		echo "<td>".GetFieldLabel("customerwastebyyear","Amount")."</td>";
	}
	echo "</tr>";
