...
$page_layouts["customerwastebyweek_search"] = $layout;
...
$mode = SEARCH_SIMPLE;
$templatefile = GetTemplateName("customerwastebyweek", "search");
...
$params['shortTableName'] = 'customerwastebyweek';
...
if ($mode==SEARCH_SIMPLE)
{
	...
	else
	{
		...
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = $pageObject->pSet->getDefaultValue( "Week" );
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
		$firstFieldParams['not'] = false;
	}
