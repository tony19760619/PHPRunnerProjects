...
$page_layouts["customerwastebyday_add"] = $layout;
...
{
	$templatefile = GetTemplateName("customerwastebyday", "inline_add");
}
else
{
	$templatefile = GetTemplateName("customerwastebyday", "add");
}
...
if(isset($_REQUEST['afteradd'])){
		HeaderRedirect("customerwastebyday", "add");
				...
				if($inlineadd==ADD_SIMPLE || $inlineadd==ADD_MASTER)
				{
					...
					if (count($keys))
					{
						...
						if($pageObject->pSet->hasEditPage() && $permis['edit'])
							$message .="&nbsp;<a href='".GetTableLink("customerwastebyday", "edit", $keylink)."'>"."Edit"."</a>&nbsp;";
						if($pageObject->pSet->hasViewPage() && $permis['search'])
							$message .="&nbsp;<a href='".GetTableLink("customerwastebyday", "view", $keylink)."'>"."View"."</a>&nbsp;";
					}
					$mesClass = "";	
				}
			}
...
if (no_output_done() && $inlineadd==ADD_SIMPLE && $IsSaved)
{
	...
	// redirect
	HeaderRedirect("customerwastebyday", $pageObject->getPageType());
...
if($pageObject->isShowDetailTables && ($inlineadd==ADD_SIMPLE || $inlineadd==ADD_POPUP) && !isMobile())
{
	...
	for($d=0;$d<count($dpParams['ids']);$d++)
	{
		...
		$options['masterTable'] = "customerwastebyday";
		$options['firstTime'] = 1;
	...
	$strTableName = "customerwastebyday";
}
/////////////////////////////////////////////////////////////
