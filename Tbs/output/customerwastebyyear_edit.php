...
$page_layouts["customerwastebyyear_edit"] = $layout;
...
if($inlineedit == EDIT_INLINE)
	$templatefile = GetTemplateName("customerwastebyyear", "inline_edit");
else 
	$templatefile = GetTemplateName("customerwastebyyear", "edit");
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	HeaderRedirect("customerwastebyyear", $pageObject->getPageType(), $keyGetQ);
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton"
	.$id."\" onclick=\"window.location.href='".GetTableLink("customerwastebyyear", "view", $viewlink)."'\"");
