...
function UsersTableName()
{
	...
	return $connection->addTableWrappers("evusers");
}
...
class tDAL
{
	var $tblTables__evcategories;
	var $tblTables__evevents;
	var $tblTables__evtellfriend;
	var $tblTables__evusers;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "evcategories", "varname" => "Tables__evcategories", "altvarname" => "evcategories", "connId" => "Tables", "schema" => "", "connName" => "events at localhost");
		$this->lstTables[] = array("name" => "evevents", "varname" => "Tables__evevents", "altvarname" => "evevents", "connId" => "Tables", "schema" => "", "connName" => "events at localhost");
		$this->lstTables[] = array("name" => "evtellfriend", "varname" => "Tables__evtellfriend", "altvarname" => "evtellfriend", "connId" => "Tables", "schema" => "", "connName" => "events at localhost");
		$this->lstTables[] = array("name" => "evusers", "varname" => "Tables__evusers", "altvarname" => "evusers", "connId" => "Tables", "schema" => "", "connName" => "events at localhost");
	}
