...
class ProjectSettings
{
	...
	*/
	...
	{
		return new ProjectSettings("evusers", PAGE_LIST);
	}
...
function GetTableURL($table = "")
{
	...
	if(!$table)
		$table=$strTableName;
	if("evcategories" == $table) 
		return "evcategories";
	if("evtellfriend" == $table) 
		return "evtellfriend";
	if("evusers" == $table) 
		return "evusers";
	if("evevents" == $table) 
...
{	
	...
	if(!$shortTName)
		return false;
	if("evcategories" == $shortTName) 
		return "evcategories";
	if("evtellfriend" == $shortTName) 
		return "evtellfriend";
	if("evusers" == $shortTName) 
		return "evusers";
	if("evevents" == $shortTName) 
		return "evevents";
}
