...
class Chart
{
	...
	protected function isProjectDB()
	{
		...
		if("evcategories" == $this->chrt_array['tables'][0])
			return true;
		if("evtellfriend" == $this->chrt_array['tables'][0])
			return true;
		if("evusers" == $this->chrt_array['tables'][0])
			return true;
		if("evevents" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
