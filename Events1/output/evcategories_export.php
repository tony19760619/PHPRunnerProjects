...
require_once("include/evcategories_variables.php");
...
$layout = new TLayout("export2", "PurificGreen", "MobileGreen");
$layout->version = 2;
...
$page_layouts["evcategories_export"] = $layout;
...
if( @$_REQUEST["a"] != "" )
{
	...
	if (@$_REQUEST["mdelete"])
	{
		...
		{
			$keys=array();
			$keys["Category"] = refine($_REQUEST["mdelete1"][mdeleteIndex($ind)]);
			$selected_recs[] = $keys;
		}
	}
