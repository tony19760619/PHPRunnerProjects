...
class ConnectionManager
{
	...
	protected function _setConnectionsData()
	{
		...
		$data["dbType"] = 0;
		$data["connId"] = "Tables";
		$data["connName"] = "events at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;Events;;1"; //currently unused
		
		$this->_connectionsIdByName["events at localhost"] = "Tables";
		...
		$data["connInfo"][2] = "";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "Events";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=Events;OPTION=3";
	...
	protected function _setTablesConnectionIds()
	{
		...
		$connectionsIds["evcategories"] = "Tables";
		$connectionsIds["evtellfriend"] = "Tables";
		$connectionsIds["evusers"] = "Tables";
		$connectionsIds["evevents"] = "Tables";
