...
class ConnectionManager
{
	...
	protected function _setConnectionsData()
	{
		...
		$data["connectionString"] = "mysql;localhost;tbs-o_tbs;yolanda;;tbs-onlinecoza_tbs;;1"; //currently unused
		
		$this->_connectionsIdByName["tbs-onlinecoza_tbs at localhost"] = "tbs_onlinecoza_tbs_at_localhost";
		
		$data["connInfo"] = array();
		$data["ODBCUID"] = "tbs-o_tbs";
		$data["ODBCPWD"] = "yolanda";
		$data["leftWrap"] = "`";
		$data["rightWrap"] = "`";
		...
		$data["connInfo"][1] = "tbs-o_tbs";
		$data["connInfo"][2] = "yolanda";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "tbs-onlinecoza_tbs";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=tbs-o_tbs;Pwd=yolanda;Database=tbs-onlinecoza_tbs;OPTION=3";
		// encription set
	...
	protected function _setTablesConnectionIds()
	{
		...
		$connectionsIds["lead"] = "tbs_onlinecoza_tbs_at_localhost";
