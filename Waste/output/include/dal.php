...
class tDAL
{
	var $tbltbs_onlinecoza_tbs_at_localhost__lead;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "lead", "varname" => "tbs_onlinecoza_tbs_at_localhost__lead", "altvarname" => "lead", "connId" => "tbs_onlinecoza_tbs_at_localhost", "schema" => "", "connName" => "tbs-onlinecoza_tbs at localhost");
	}
