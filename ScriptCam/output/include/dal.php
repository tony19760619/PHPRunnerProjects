...
class tDAL
{
	var $tblkhmerban_finance_at_localhost__accounts;
	var $tblkhmerban_finance_at_localhost__users;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "accounts", "varname" => "khmerban_finance_at_localhost__accounts", "altvarname" => "accounts", "connId" => "khmerban_finance_at_localhost", "schema" => "", "connName" => "khmerban_finance at localhost");
		$this->lstTables[] = array("name" => "users", "varname" => "khmerban_finance_at_localhost__users", "altvarname" => "users", "connId" => "khmerban_finance_at_localhost", "schema" => "", "connName" => "khmerban_finance at localhost");
	}
