...
class ConnectionManager
{
	...
	{
		return $this->byId( "khmerban_finance_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "khmerban_finance_at_localhost";
		$data["connName"] = "khmerban_finance at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;khmerban_finance;;1"; //currently unused
		
		$this->_connectionsIdByName["khmerban_finance at localhost"] = "khmerban_finance_at_localhost";
		...
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=khmerban_finance;OPTION=3";
		$connectionsData["khmerban_finance_at_localhost"] = $data;
	...
	protected function _setTablesConnectionIds()
	{
		...
		$connectionsIds["users"] = "khmerban_finance_at_localhost";
