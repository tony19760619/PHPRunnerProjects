...
class Chart
{
	...
	protected function isProjectDB()
	{
		...
		if("transactions" == $this->chrt_array['tables'][0])
			return true;
		...
		if("transactions" == $this->chrt_array['tables'][0])
			return true;
		if("recordidcounter" == $this->chrt_array['tables'][0])
			return true;
		if("transactions" == $this->chrt_array['tables'][0])
			return true;
		if("transactions" == $this->chrt_array['tables'][0])
		...
		if("accounts" == $this->chrt_array['tables'][0])
			return true;
		if("finance_ugrights" == $this->chrt_array['tables'][0])
			return true;
		if("users" == $this->chrt_array['tables'][0])
			return true;
		if("users" == $this->chrt_array['tables'][0])
		...
		if("users" == $this->chrt_array['tables'][0])
			return true;
		if("schedule" == $this->chrt_array['tables'][0])
			return true;
