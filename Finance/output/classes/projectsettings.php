...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "transactions" ] = array( "url" => "transactions", "type" => 0 );
	$projectEntitiesReverse[ "transactions" ] = "transactions";
	...
	$projectEntities[ "LookUps" ] = array( "url" => "LookUps", "type" => 0 );
	$projectEntitiesReverse[ "LookUps" ] = "LookUps";
	$projectEntities[ "usersLookUp" ] = array( "url" => "usersLookUp", "type" => 1 );
	$projectEntitiesReverse[ "usersLookUp" ] = "usersLookUp";
	$projectEntities[ "accountsLookUp" ] = array( "url" => "accountsLookUp", "type" => 1 );
	$projectEntitiesReverse[ "accountsLookUp" ] = "accountsLookUp";
	$projectEntities[ "loanaccounts" ] = array( "url" => "loanaccounts", "type" => 1 );
	$projectEntitiesReverse[ "loanaccounts" ] = "loanaccounts";
	$projectEntities[ "CashDeposit" ] = array( "url" => "CashDeposit", "type" => 1 );
	$projectEntitiesReverse[ "CashDeposit" ] = "CashDeposit";
	$projectEntities[ "CashWithdrawl" ] = array( "url" => "CashWithdrawl", "type" => 1 );
	$projectEntitiesReverse[ "CashWithdrawl" ] = "CashWithdrawl";
	$projectEntities[ "LoanCredit" ] = array( "url" => "LoanCredit", "type" => 1 );
	$projectEntitiesReverse[ "LoanCredit" ] = "LoanCredit";
	$projectEntities[ "LoanPayment" ] = array( "url" => "LoanPayment", "type" => 1 );
	$projectEntitiesReverse[ "LoanPayment" ] = "LoanPayment";
	$projectEntities[ "SavingsStatements" ] = array( "url" => "SavingsStatements", "type" => 1 );
	$projectEntitiesReverse[ "SavingsStatements" ] = "SavingsStatements";
	$projectEntities[ "LoanStatements" ] = array( "url" => "LoanStatements", "type" => 1 );
	$projectEntitiesReverse[ "LoanStatements" ] = "LoanStatements";
	$projectEntities[ "MonthlyBalanceSheet" ] = array( "url" => "MonthlyBalanceSheet", "type" => 1 );
	$projectEntitiesReverse[ "MonthlyBalanceSheet" ] = "MonthlyBalanceSheet";
	$projectEntities[ "BalaceEnquiry" ] = array( "url" => "BalaceEnquiry", "type" => 1 );
	$projectEntitiesReverse[ "BalaceEnquiry" ] = "BalaceEnquiry";
	$projectEntities[ "NEFTTransfer" ] = array( "url" => "NEFTTransfer", "type" => 1 );
	$projectEntitiesReverse[ "NEFTTransfer" ] = "NEFTTransfer";
	$projectEntities[ "recordidcounter" ] = array( "url" => "recordidcounter", "type" => 0 );
	$projectEntitiesReverse[ "recordidcounter" ] = "recordidcounter";
	$projectEntities[ "YearlyBalanceSheet" ] = array( "url" => "YearlyBalanceSheet", "type" => 1 );
	$projectEntitiesReverse[ "YearlyBalanceSheet" ] = "YearlyBalanceSheet";
	$projectEntities[ "TransactionLog" ] = array( "url" => "TransactionLog", "type" => 1 );
	$projectEntitiesReverse[ "TransactionLog" ] = "TransactionLog";
	$projectEntities[ "ClientCashWithdrawl" ] = array( "url" => "ClientCashWithdrawl", "type" => 1 );
	$projectEntitiesReverse[ "ClientCashWithdrawl" ] = "ClientCashWithdrawl";
	$projectEntities[ "ClientLoanCredit" ] = array( "url" => "ClientLoanCredit", "type" => 1 );
	$projectEntitiesReverse[ "ClientLoanCredit" ] = "ClientLoanCredit";
	$projectEntities[ "ClientSavingsAccounts" ] = array( "url" => "ClientSavingsAccounts", "type" => 1 );
	$projectEntitiesReverse[ "ClientSavingsAccounts" ] = "ClientSavingsAccounts";
	$projectEntities[ "ClientLoanAccounts" ] = array( "url" => "ClientLoanAccounts", "type" => 1 );
	$projectEntitiesReverse[ "ClientLoanAccounts" ] = "ClientLoanAccounts";
	$projectEntities[ "SavingsAccounts" ] = array( "url" => "SavingsAccounts", "type" => 1 );
	$projectEntitiesReverse[ "SavingsAccounts" ] = "SavingsAccounts";
	$projectEntities[ "MonthlyStatement" ] = array( "url" => "MonthlyStatement", "type" => 1 );
	$projectEntitiesReverse[ "MonthlyStatement" ] = "MonthlyStatement";
	$projectEntities[ "YearlyStatement" ] = array( "url" => "YearlyStatement", "type" => 1 );
	$projectEntitiesReverse[ "YearlyStatement" ] = "YearlyStatement";
	$projectEntities[ "usersLookupFiltered" ] = array( "url" => "usersLookupFiltered", "type" => 1 );
	$projectEntitiesReverse[ "usersLookupFiltered" ] = "usersLookupFiltered";
	$projectEntities[ "accountsLookUpFiltered" ] = array( "url" => "accountsLookUpFiltered", "type" => 1 );
	$projectEntitiesReverse[ "accountsLookUpFiltered" ] = "accountsLookUpFiltered";
	...
	$projectEntities[ "ClientAccounts" ] = array( "url" => "ClientAccounts", "type" => 1 );
	$projectEntitiesReverse[ "ClientAccounts" ] = "ClientAccounts";
	$projectEntities[ "schedule" ] = array( "url" => "schedule", "type" => 0 );
	$projectEntitiesReverse[ "schedule" ] = "schedule";
