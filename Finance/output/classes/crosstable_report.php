...
class CrossTableReport
{
	...
	public function isProjectDB()
	{
		...
		$isDB = false;
		if("transactions" == $this->xml_array['tables'][0])
			$isDB = true;
		if("accounts" == $this->xml_array['tables'][0])
			$isDB = true;
		if("users" == $this->xml_array['tables'][0])
			$isDB = true;
		if("LookUps" == $this->xml_array['tables'][0])
			$isDB = true;
		if("users" == $this->xml_array['tables'][0])
			$isDB = true;
		if("accounts" == $this->xml_array['tables'][0])
		...
		if("transactions" == $this->xml_array['tables'][0])
			$isDB = true;
		if("recordidcounter" == $this->xml_array['tables'][0])
			$isDB = true;
		if("transactions" == $this->xml_array['tables'][0])
			$isDB = true;
		if("transactions" == $this->xml_array['tables'][0])
		...
		if("accounts" == $this->xml_array['tables'][0])
			$isDB = true;
		if("finance_ugrights" == $this->xml_array['tables'][0])
			$isDB = true;
		if("users" == $this->xml_array['tables'][0])
			$isDB = true;
		if("users" == $this->xml_array['tables'][0])
		...
		if("users" == $this->xml_array['tables'][0])
			$isDB = true;
		if("schedule" == $this->xml_array['tables'][0])
			$isDB = true;
		if("loan" == $this->xml_array['tables'][0])
			$isDB = true;
		return $isDB;
	}
