...
require_once("include/BalanceSheet_variables.php");
...
$page_layouts["BalanceSheet_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "BalanceSheet" );
