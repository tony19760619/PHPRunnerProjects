...
$nonAdminTablesArr[] = "accounts";
$nonAdminTablesArr[] = "users";
$nonAdminTablesArr[] = "LookUps";
$nonAdminTablesArr[] = "usersLookUp";
$nonAdminTablesArr[] = "accountsLookUp";
$nonAdminTablesArr[] = "loanaccounts";
$nonAdminTablesArr[] = "CashDeposit";
$nonAdminTablesArr[] = "CashWithdrawl";
$nonAdminTablesArr[] = "LoanCredit";
$nonAdminTablesArr[] = "LoanPayment";
$nonAdminTablesArr[] = "SavingsStatements";
$nonAdminTablesArr[] = "LoanStatements";
$nonAdminTablesArr[] = "MonthlyBalanceSheet";
$nonAdminTablesArr[] = "BalaceEnquiry";
$nonAdminTablesArr[] = "NEFTTransfer";
$nonAdminTablesArr[] = "recordidcounter";
$nonAdminTablesArr[] = "YearlyBalanceSheet";
$nonAdminTablesArr[] = "TransactionLog";
$nonAdminTablesArr[] = "ClientCashWithdrawl";
$nonAdminTablesArr[] = "ClientLoanCredit";
$nonAdminTablesArr[] = "ClientSavingsAccounts";
$nonAdminTablesArr[] = "ClientLoanAccounts";
$nonAdminTablesArr[] = "SavingsAccounts";
$nonAdminTablesArr[] = "MonthlyStatement";
$nonAdminTablesArr[] = "YearlyStatement";
$nonAdminTablesArr[] = "usersLookupFiltered";
$nonAdminTablesArr[] = "accountsLookUpFiltered";
$nonAdminTablesArr[] = "ClientAccounts";
$nonAdminTablesArr[] = "schedule";
$nonAdminTablesArr[] = "loan";
...
$wGroupTableName = $ug_connection->addTableWrappers( "finance_uggroups" );
...
switch(postvalue("a"))
{
	...
	case "del":
		...
		$sql = "delete from ". $ug_connection->addTableWrappers( "finance_ugrights" ) 
			." where ". $ug_connection->addFieldWrappers( "GroupID" ) ."=".(postvalue("id")+0);
		$ug_connection->exec( $sql );
		
		$sql = "delete from ".$ug_connection->addTableWrappers( "finance_ugmembers" ) 
			." where ". $ug_connection->addFieldWrappers( "GroupID" ) ."=".(postvalue("id")+0);
		$ug_connection->exec( $sql );
	...
	case 'saveRights':
		...
		{	
			...
			$wRightsTableName = $ug_connection->addTableWrappers( "finance_ugrights" );
	...
	case 'saveMembership':
		...
		$wMemebersTableName = $ug_connection->addTableWrappers( "finance_ugmembers" );
