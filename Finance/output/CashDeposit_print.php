...
require_once("include/CashDeposit_variables.php");
...
$page_layouts["CashDeposit_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "CashDeposit" );
