...
require_once("include/usersLookupFiltered_variables.php");
...
$page_layouts["usersLookupFiltered_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "usersLookupFiltered" );
