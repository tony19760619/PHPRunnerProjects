...
require_once("include/recordidcounter_variables.php");
...
$page_layouts["recordidcounter_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "recordidcounter" );
