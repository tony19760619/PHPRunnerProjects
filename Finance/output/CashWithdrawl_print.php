...
require_once("include/CashWithdrawl_variables.php");
...
$page_layouts["CashWithdrawl_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "CashWithdrawl" );
