...
require_once("include/ClientAccounts_variables.php");
...
$layout = new TLayout("add2", "RoundedOffice", "MobileOffice");
$layout->version = 2;
...
$page_layouts["ClientAccounts_add"] = $layout;
...
$page_layouts["ClientAccounts_list"] = $layout;
...
$layout = new TLayout("tab", "RoundedOffice", "MobileOffice");
$layout->version = 2;
...
$page_layouts["ClientAccounts_add_Step1"] = $layout;
...
$layout->blocks["bare"][] = "1";
$page_layouts["ClientAccounts_add_Step2"] = $layout;
...
$layout->blocks["bare"][] = "1";
$page_layouts["ClientAccounts_add_Saving_Account_Info1"] = $layout;
...
$layout->blocks["bare"][] = "1";
$page_layouts["ClientAccounts_add_User_Details1"] = $layout;
