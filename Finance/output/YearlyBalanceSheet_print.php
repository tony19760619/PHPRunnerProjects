...
require_once("include/YearlyBalanceSheet_variables.php");
...
$page_layouts["YearlyBalanceSheet_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "YearlyBalanceSheet" );
