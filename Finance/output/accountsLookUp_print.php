...
require_once("include/accountsLookUp_variables.php");
...
$page_layouts["accountsLookUp_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "accountsLookUp" );
