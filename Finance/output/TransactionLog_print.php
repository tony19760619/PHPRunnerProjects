...
require_once("include/TransactionLog_variables.php");
...
$page_layouts["TransactionLog_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "TransactionLog" );
