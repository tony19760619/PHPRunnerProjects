...
require_once("include/loanaccounts_variables.php");
...
$layout = new TLayout("view2", "RoundedOffice", "MobileOffice");
$layout->version = 2;
...
$page_layouts["loanaccounts_view"] = $layout;
...
$layout = new TLayout("viewtab", "RoundedOffice", "MobileOffice");
$layout->version = 2;
$layout->blocks["bare"] = array();
$layout->containers["1"] = array();
$layout->container_properties["1"] = array(  );
$layout->containers["1"][] = array("name"=>"viewtabfields",
	"block"=>"", "substyle"=>1  );

$layout->skins["1"] = "empty";

$layout->blocks["bare"][] = "1";
$page_layouts["loanaccounts_view_Account_Info_11"] = $layout;
...
$layout->blocks["bare"][] = "1";
$page_layouts["loanaccounts_view_Account_Info_21"] = $layout;
