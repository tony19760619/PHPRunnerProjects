...
include_once('custumfunctions.php');
...
function fileCustomExpression($file, $data, $field, $ptype, $table="")
{
	...
	if(!$table)
		$table = $strTableName;
				if($table=="users" && $field=="ProfilePhoto")
	{
		;
		return $value;
	}
				if($table=="users" && $field=="AttachedFile")
	{
		;
		return $value;
	}
				if($table=="usersLookupFiltered" && $field=="ProfilePhoto")
	{
		;
		return $value;
	}
				if($table=="usersLookupFiltered" && $field=="AttachedFile")
	{
		;
		return $value;
	}
				if($table=="admin_members" && $field=="ProfilePhoto")
	{
		;
		return $value;
	}
				if($table=="admin_members" && $field=="AttachedFile")
	{
		;
		return $value;
	}
				if($table=="admin_users" && $field=="ProfilePhoto")
	{
		;
		return $value;
	}
				if($table=="admin_users" && $field=="AttachedFile")
	{
		;
		return $value;
	}
...
function GetLWWhere($field, $ptype, $table = "")
{
	...
	if(!$table)
		$table = $strTableName;
				if($table=="transactions" && $field=="CashDepositType")
	{
		return " Type = 'CashDepositType' ";
	}
				if($table=="transactions" && $field=="WithdrawlType")
	{
		return " Type = 'WithdrawlType' ";
	}
				if($table=="transactions" && $field=="LoanPaymentPurpose")
	{
		return " Type = 'LoanPaymentPurpose' ";
	}
				if($table=="transactions" && $field=="AccountType")
	{
		return " Type = 'AccountType' ";
	}
				if($table=="transactions" && $field=="WithdrawlStatus" && $ptype=="edit")
	{
		return " Type = 'WithdrawlStatus' ";
	}
				if($table=="transactions" && $field=="WithdrawlStatus" && $ptype=="search")
	{
		return " Type = 'WithdrawlStatus' ";
	}
				if($table=="transactions" && $field=="NEFTTransferStatus" && $ptype=="edit")
	{
		return " Type = 'NEFTTransferStatus' ";
	}
				if($table=="transactions" && $field=="NEFTTransferStatus" && $ptype=="search")
	{
		return " Type = 'NEFTTransferStatus' ";
	}
				if($table=="transactions" && $field=="LoanCreditApplicationStatus" && $ptype=="edit")
	{
		return " Type = 'LoanCreditApplicationStatus' ";
	}
				if($table=="transactions" && $field=="LoanCreditApplicationStatus" && $ptype=="search")
	{
		return " Type = 'LoanCreditApplicationStatus' ";
	}
				if($table=="accounts" && $field=="AccountType")
	{
		return " Type = 'AccountType' ";
	}
				if($table=="users" && $field=="Sex")
	{
		return " Type = 'Sex' ";
	}
				if($table=="users" && $field=="EmergencyContactRelation")
	{
		return " Type = 'EmergencyContactRelation' ";
	}
				if($table=="users" && $field=="UserLevel")
	{
		return " Type = 'UserLevel' ";
	}
				if($table=="usersLookUp" && $field=="Sex")
	{
		return " Type = 'Sex' ";
	}
				if($table=="usersLookUp" && $field=="EmergencyContactRelation")
	{
		return " Type = 'EmergencyContactRelation' ";
	}
				if($table=="accountsLookUp" && $field=="AccountType")
	{
		return " Type = 'AccountType' ";
	}
				if($table=="loanaccounts" && $field=="LoanCreditPaymentPurpose" && $ptype=="add")
	{
		return " Type = 'LoanCreditPaymentPurpose' ";
	}
				if($table=="loanaccounts" && $field=="LoanCreditPaymentPurpose" && $ptype=="search")
	{
		return " Type = 'LoanCreditPaymentPurpose' ";
	}
				if($table=="CashDeposit" && $field=="CashDepositType" && $ptype=="add")
	{
		return " Type = 'CashDepositType' ";
	}
				if($table=="CashDeposit" && $field=="CashDepositType" && $ptype=="search")
	{
		return " Type = 'CashDepositType' ";
	}
				if($table=="CashDeposit" && $field=="TransactionStatus" && $ptype=="edit")
	{
		return " Type = 'CashDepositTransactionStatus' ";
	}
				if($table=="CashDeposit" && $field=="TransactionStatus" && $ptype=="search")
	{
		return " Type = 'CashDepositTransactionStatus' ";
	}
				if($table=="CashDeposit" && $field=="AccountType" && $ptype=="search")
	{
		return " Type = 'CashDepositType' ";
	}
				if($table=="CashWithdrawl" && $field=="WithdrawlType" && $ptype=="add")
	{
		return " Type = 'WithdrawlType' ";
	}
				if($table=="CashWithdrawl" && $field=="WithdrawlType" && $ptype=="search")
	{
		return " Type = 'WithdrawlType' ";
	}
				if($table=="CashWithdrawl" && $field=="WithdrawlStatus" && $ptype=="edit")
	{
		return " Type = 'WithdrawlStatus' ";
	}
				if($table=="CashWithdrawl" && $field=="WithdrawlStatus" && $ptype=="search")
	{
		return " Type = 'WithdrawlStatus' ";
	}
				if($table=="CashWithdrawl" && $field=="TransactionStatus" && $ptype=="edit")
	{
		return " Type = 'CashWithdrawlTransactionStatus' ";
	}
				if($table=="CashWithdrawl" && $field=="TransactionStatus" && $ptype=="search")
	{
		return " Type = 'CashWithdrawlTransactionStatus' ";
	}
				if($table=="CashWithdrawl" && $field=="AccountType" && $ptype=="search")
	{
		return " Type = 'AccountType' ";
	}
				if($table=="LoanCredit" && $field=="LoanCreditPaymentPurpose" && $ptype=="add")
	{
		return " Type = 'LoanCreditPaymentPurpose' ";
	}
				if($table=="LoanCredit" && $field=="LoanCreditPaymentPurpose" && $ptype=="search")
	{
		return " Type = 'LoanCreditPaymentPurpose' ";
	}
				if($table=="LoanCredit" && $field=="LoanCreditApplicationStatus" && $ptype=="edit")
	{
		return " Type = 'LoanCreditApplicationStatus' ";
	}
				if($table=="LoanCredit" && $field=="LoanCreditApplicationStatus" && $ptype=="search")
	{
		return " Type = 'LoanCreditApplicationStatus' ";
	}
				if($table=="LoanCredit" && $field=="AccountNumber" && $ptype=="add")
	{
		return " AccountType = 'Loan' ";
	}
				if($table=="LoanCredit" && $field=="TransactionStatus" && $ptype=="edit")
	{
		return " Type = 'TransactionStatus' ";
	}
				if($table=="LoanCredit" && $field=="TransactionStatus" && $ptype=="search")
	{
		return " Type = 'TransactionStatus' ";
	}
				if($table=="LoanPayment" && $field=="LoanPaymentPurpose" && $ptype=="add")
	{
		return " Type = 'LoanPaymentPurpose' ";
	}
				if($table=="LoanPayment" && $field=="LoanPaymentPurpose" && $ptype=="search")
	{
		return " Type = 'LoanPaymentPurpose' ";
	}
				if($table=="LoanPayment" && $field=="AccountNumber" && $ptype=="add")
	{
		return " AccountType = 'Loan' ";
	}
				if($table=="LoanPayment" && $field=="TransactionStatus" && $ptype=="edit")
	{
		return " Type = 'TransactionStatus' ";
	}
				if($table=="LoanPayment" && $field=="TransactionStatus" && $ptype=="search")
	{
		return " Type = 'TransactionStatus' ";
	}
				if($table=="LoanPayment" && $field=="LoanPaymentStatus" && $ptype=="edit")
	{
		return " Type = 'LoanPaymentStatus' ";
	}
				if($table=="LoanPayment" && $field=="LoanPaymentStatus" && $ptype=="search")
	{
		return " Type = 'LoanPaymentStatus' ";
	}
				if($table=="SavingsStatements" && $field=="CashDepositType" && $ptype=="search")
	{
		return " Type = 'CashDepositType' ";
	}
				if($table=="SavingsStatements" && $field=="WithdrawlType" && $ptype=="search")
	{
		return " Type = 'WithdrawlType' ";
	}
				if($table=="SavingsStatements" && $field=="AccountType" && $ptype=="edit")
	{
		return " Type = 'AccountType' ";
	}
				if($table=="SavingsStatements" && $field=="AccountType" && $ptype=="search")
	{
		return " Type = 'AccountType' ";
	}
				if($table=="LoanStatements" && $field=="LoanPaymentPurpose" && $ptype=="search")
	{
		return " Type = 'LoanPaymentPurpose' ";
	}
				if($table=="LoanStatements" && $field=="LoanCreditPaymentPurpose" && $ptype=="edit")
	{
		return " Type = 'LoanCreditPaymentPurpose' ";
	}
				if($table=="LoanStatements" && $field=="LoanCreditPaymentPurpose" && $ptype=="search")
	{
		return " Type = 'LoanCreditPaymentPurpose' ";
	}
				if($table=="LoanStatements" && $field=="AccountType" && $ptype=="edit")
	{
		return " Type = 'AccountType' ";
	}
				if($table=="LoanStatements" && $field=="AccountType" && $ptype=="search")
	{
		return " Type = 'AccountType' ";
	}
				if($table=="BalaceEnquiry" && $field=="AccountType")
	{
		return " Type = 'AccountType' ";
	}
				if($table=="ClientCashWithdrawl" && $field=="WithdrawlType")
	{
		return " Type = 'WithdrawlType' ";
	}
				if($table=="ClientCashWithdrawl" && $field=="WithdrawlStatus" && $ptype=="edit")
	{
		return " Type = 'WithdrawlStatus' ";
	}
				if($table=="ClientCashWithdrawl" && $field=="WithdrawlStatus" && $ptype=="search")
	{
		return " Type = 'WithdrawlStatus' ";
	}
				if($table=="ClientLoanCredit" && $field=="LoanCreditApplicationStatus" && $ptype=="edit")
	{
		return " Type = 'LoanCreditApplicationStatus' ";
	}
				if($table=="ClientLoanCredit" && $field=="LoanCreditApplicationStatus" && $ptype=="search")
	{
		return " Type = 'LoanCreditApplicationStatus' ";
	}
				if($table=="ClientSavingsAccounts" && $field=="AccountType")
	{
		return " Type = 'AccountType' ";
	}
				if($table=="ClientLoanAccounts" && $field=="AccountType")
	{
		return " Type = 'AccountType' ";
	}
				if($table=="MonthlyStatement" && $field=="AccountType")
	{
		return " Type = 'AccountType' ";
	}
				if($table=="YearlyStatement" && $field=="AccountType")
	{
		return " Type = 'AccountType' ";
	}
				if($table=="usersLookupFiltered" && $field=="Sex")
	{
		return " Type = 'Sex' ";
	}
				if($table=="usersLookupFiltered" && $field=="EmergencyContactRelation")
	{
		return " Type = 'EmergencyContactRelation' ";
	}
				if($table=="accountsLookUpFiltered" && $field=="AccountType")
	{
		return " Type = 'AccountType' ";
	}
				if($table=="admin_members" && $field=="Sex")
	{
		return " Type = 'Sex' ";
	}
				if($table=="admin_members" && $field=="EmergencyContactRelation")
	{
		return " Type = 'EmergencyContactRelation' ";
	}
				if($table=="admin_users" && $field=="Sex")
	{
		return " Type = 'Sex' ";
	}
				if($table=="admin_users" && $field=="EmergencyContactRelation")
	{
		return " Type = 'EmergencyContactRelation' ";
	}
				if($table=="ClientAccounts" && $field=="Sex")
	{
		return " Type = 'Sex' ";
	}
				if($table=="ClientAccounts" && $field=="EmergencyContactRelation")
	{
		return " Type = 'EmergencyContactRelation' ";
	}
				if($table=="ClientAccounts" && $field=="UserLevel" && $ptype=="add")
	{
		return " Type = 'UserLevel' ";
	}
				if($table=="ClientAccounts" && $field=="UserLevel" && $ptype=="search")
	{
		return " Type = 'UserLevel' ";
	}
	return "";
...
function GetDefaultValue($field, $ptype, $table="")
{
	...
	if(!$table)
		$table=$strTableName;
				if($table=="transactions" && $field=="DateTime")
	{
		return now();
	}
				if($table=="transactions" && $field=="CashDepositNo" && $ptype=="edit")
	{
		return GetRecordCounterID('CashDepositNo');
	}
				if($table=="transactions" && $field=="CashDepositNo" && $ptype=="add")
	{
		return GetRecordCounterID('CashDepositNo');
	}
				if($table=="transactions" && $field=="CashDepositNo" && $ptype=="search")
	{
		return GetRecordCounterID('CashDepositNo');
	}
				if($table=="transactions" && $field=="WithdrawlNo" && $ptype=="edit")
	{
		return GetRecordCounterID('WithdrawlNo');
	}
				if($table=="transactions" && $field=="WithdrawlNo" && $ptype=="add")
	{
		return GetRecordCounterID('WithdrawlNo');
	}
				if($table=="transactions" && $field=="WithdrawlNo" && $ptype=="search")
	{
		return GetRecordCounterID('WithdrawlNo');
	}
				if($table=="transactions" && $field=="LoanPaymentNo" && $ptype=="edit")
	{
		return GetRecordCounterID('LoanPaymentNo');
	}
				if($table=="transactions" && $field=="LoanPaymentNo" && $ptype=="add")
	{
		return GetRecordCounterID('LoanPaymentNo');
	}
				if($table=="transactions" && $field=="LoanPaymentNo" && $ptype=="search")
	{
		return GetRecordCounterID('LoanPaymentNo');
	}
				if($table=="transactions" && $field=="LoanCreditPaymentNo" && $ptype=="edit")
	{
		return GetRecordCounterID('LoanCreditPaymentNo');
	}
				if($table=="transactions" && $field=="LoanCreditPaymentNo" && $ptype=="add")
	{
		return GetRecordCounterID('LoanCreditPaymentNo');
	}
				if($table=="transactions" && $field=="LoanCreditPaymentNo" && $ptype=="search")
	{
		return GetRecordCounterID('LoanCreditPaymentNo');
	}
				if($table=="transactions" && $field=="WithdrawlStatus" && $ptype=="add")
	{
		return "Pending";
	}
				if($table=="transactions" && $field=="NEFTTransferStatus" && $ptype=="add")
	{
		return "Pending";
	}
				if($table=="transactions" && $field=="LoanCreditApplicationStatus" && $ptype=="add")
	{
		return "Pending";
	}
				if($table=="transactions" && $field=="LastModifiedBy")
	{
		return $_SESSION["UserName"];
	}
				if($table=="transactions" && $field=="LastModifiedDate")
	{
		return now();
	}
				if($table=="accounts" && $field=="AccountBalance")
	{
		return 0;
	}
				if($table=="accounts" && $field=="OpeningBalance")
	{
		return 0;
	}
				if($table=="accounts" && $field=="InterestRate")
	{
		return 0;
	}
				if($table=="accounts" && $field=="LastModifiedBy")
	{
		return $_SESSION["UserName"];
	}
				if($table=="accounts" && $field=="LastModifiedDate")
	{
		return now();
	}
				if($table=="users" && $field=="ClientNo" && $ptype=="add")
	{
		return GetRecordCounterID('ClientNo');
	}
				if($table=="users" && $field=="LastModifiedBy")
	{
		return $_SESSION["UserName"];
	}
				if($table=="users" && $field=="LastModifiedDate")
	{
		return now();
	}
				if($table=="users" && $field=="OpeningAccountDate")
	{
		return now();
	}
				if($table=="users" && $field=="UserLevel")
	{
		return "Client";
				...
				if($table=="users" && $field=="InterestRate" && $ptype=="add")
	{
		return 0;
	}
				if($table=="accountsLookUp" && $field=="AccountBalance")
	{
		return 0;
	}
				if($table=="accountsLookUp" && $field=="OpeningBalance")
	{
		return 0;
	}
				if($table=="accountsLookUp" && $field=="InterestRate")
	{
		return 0;
	}
				if($table=="loanaccounts" && $field=="AccountNumber" && $ptype=="edit")
	{
		return GetRecordCounterID('LoanAccountNo');
	}
				if($table=="loanaccounts" && $field=="AccountNumber" && $ptype=="add")
	{
		return GetRecordCounterID('LoanAccountNo');
	}
				if($table=="loanaccounts" && $field=="AccountBalance" && $ptype=="edit")
	{
		return 0;
	}
				if($table=="loanaccounts" && $field=="AccountBalance" && $ptype=="add")
	{
		return 0;
	}
				if($table=="loanaccounts" && $field=="AccountBalance" && $ptype=="search")
	{
		return 0;
	}
				if($table=="loanaccounts" && $field=="LastTransactionDate")
	{
		return now();
	}
				if($table=="loanaccounts" && $field=="OpeningBalance" && $ptype=="edit")
	{
		return 0;
	}
				if($table=="loanaccounts" && $field=="OpeningBalance" && $ptype=="add")
	{
		return 0;
	}
				if($table=="loanaccounts" && $field=="OpeningBalance" && $ptype=="search")
	{
		return 0;
	}
				if($table=="loanaccounts" && $field=="InterestRate")
	{
		return 0;
	}
				if($table=="loanaccounts" && $field=="AccountType" && $ptype=="edit")
	{
		return "Loan";
	}
				if($table=="loanaccounts" && $field=="AccountType" && $ptype=="add")
	{
		return "Loan";
	}
				if($table=="loanaccounts" && $field=="AccountType" && $ptype=="search")
	{
		return "Loan";
	}
				if($table=="loanaccounts" && $field=="LastModifiedBy")
	{
		return $_SESSION["UserName"];
	}
				if($table=="loanaccounts" && $field=="LastModifiedDate")
	{
		return now();
	}
				if($table=="loanaccounts" && $field=="LoanCreditPaymentPurpose" && $ptype=="add")
	{
		return "Loan Amount";
				...
				if($table=="CashDeposit" && $field=="CashDepositNo" && $ptype=="add")
	{
		return GetRecordCounterID('CashDepositNo');
	}
				if($table=="CashDeposit" && $field=="DateTime")
	{
		return now();
	}
				if($table=="CashDeposit" && $field=="LastModifiedBy")
	{
		return $_SESSION["UserName"];
	}
				if($table=="CashDeposit" && $field=="LastModifiedDate")
	{
		return now();
	}
				if($table=="CashDeposit" && $field=="TransactionStatus" && $ptype=="edit")
	{
		return "Pending";
				...
				if($table=="CashDeposit" && $field=="TransactionStatus" && $ptype=="add")
	{
		return "Pending";
	}
				if($table=="CashDeposit" && $field=="TransactionStatus" && $ptype=="search")
	{
		return "Pending";
				...
				if($table=="CashDeposit" && $field=="TransactionNo")
	{
		return GetRecordCounterID('CashDepositNo');
	}
				if($table=="CashWithdrawl" && $field=="WithdrawlNo" && $ptype=="edit")
	{
		return GetRecordCounterID('WithdrawlNo');
	}
				if($table=="CashWithdrawl" && $field=="WithdrawlNo" && $ptype=="search")
	{
		return GetRecordCounterID('WithdrawlNo');
	}
				if($table=="CashWithdrawl" && $field=="DateTime")
	{
		return now();
	}
				if($table=="CashWithdrawl" && $field=="WithdrawlStatus" && $ptype=="add")
	{
		return "Pending";
	}
				if($table=="CashWithdrawl" && $field=="LastModifiedBy")
	{
		return $_SESSION["UserName"];
	}
				if($table=="CashWithdrawl" && $field=="LastModifiedDate")
	{
		return now();
	}
				if($table=="CashWithdrawl" && $field=="TransactionStatus" && $ptype=="add")
	{
		return "Pending";
	}
				if($table=="CashWithdrawl" && $field=="TransactionNo")
	{
		return GetRecordCounterID('WithdrawlNo');
	}
				if($table=="LoanCredit" && $field=="DateTime")
	{
		return now();
	}
				if($table=="LoanCredit" && $field=="LoanCreditApplicationStatus" && $ptype=="add")
	{
		return "Pending";
	}
				if($table=="LoanCredit" && $field=="LastModifiedBy")
	{
		return $_SESSION["UserName"];
	}
				if($table=="LoanCredit" && $field=="LastModifiedDate")
	{
		return now();
	}
				if($table=="LoanCredit" && $field=="TransactionStatus" && $ptype=="add")
	{
		return "Pending";
	}
				if($table=="LoanCredit" && $field=="TransactionNo")
	{
		return GetRecordCounterID('LoanCreditPaymentNo');
	}
				if($table=="LoanPayment" && $field=="DateTime")
	{
		return now();
	}
				if($table=="LoanPayment" && $field=="LastModifiedBy")
	{
		return $_SESSION["UserName"];
	}
				if($table=="LoanPayment" && $field=="LastModifiedDate")
	{
		return now();
	}
				if($table=="LoanPayment" && $field=="TransactionStatus" && $ptype=="add")
	{
		return "Pending";
	}
				if($table=="LoanPayment" && $field=="LoanPaymentStatus" && $ptype=="add")
	{
		return "Pending";
	}
				if($table=="LoanPayment" && $field=="TransactionNo" && $ptype=="edit")
	{
		return GetRecordCounterID('LoanPaymentNo');
	}
				if($table=="LoanPayment" && $field=="TransactionNo" && $ptype=="add")
	{
		return GetRecordCounterID('LoanPaymentNo');
	}
				if($table=="LoanPayment" && $field=="TransactionNo" && $ptype=="search")
	{
		return GetRecordCounterID('LoanPaymentNo');
	}
				if($table=="SavingsStatements" && $field=="DateTime")
	{
		return now();
	}
				if($table=="SavingsStatements" && $field=="LastModifiedBy")
	{
		return $_SESSION["UserName"];
	}
				if($table=="SavingsStatements" && $field=="LastModifiedDate")
	{
		return now();
	}
				if($table=="LoanStatements" && $field=="DateTime")
	{
		return now();
	}
				if($table=="LoanStatements" && $field=="LastModifiedBy")
	{
		return $_SESSION["UserName"];
	}
				if($table=="LoanStatements" && $field=="LastModifiedDate")
	{
		return now();
	}
				if($table=="BalaceEnquiry" && $field=="AccountBalance")
	{
		return 0;
	}
				if($table=="BalaceEnquiry" && $field=="InterestRate")
	{
		return 0;
	}
				if($table=="BalaceEnquiry" && $field=="LastModifiedBy")
	{
		return $_SESSION["UserName"];
	}
				if($table=="BalaceEnquiry" && $field=="LastModifiedDate")
	{
		return now();
	}
				if($table=="NEFTTransfer" && $field=="NEFTTransferNo" && $ptype=="add")
	{
		return GetRecordCounterID('NEFTTransferNo');
	}
				if($table=="NEFTTransfer" && $field=="DateTime")
	{
		return now();
	}
				if($table=="NEFTTransfer" && $field=="LastModifiedBy")
	{
		return $_SESSION["UserName"];
	}
				if($table=="NEFTTransfer" && $field=="LastModifiedDate")
	{
		return now();
	}
				if($table=="TransactionLog" && $field=="DateTime")
	{
		return now();
	}
				if($table=="TransactionLog" && $field=="LastModifiedBy")
	{
		return $_SESSION["UserName"];
	}
				if($table=="TransactionLog" && $field=="LastModifiedDate")
	{
		return now();
	}
				if($table=="ClientCashWithdrawl" && $field=="WithdrawlNo" && $ptype=="edit")
	{
		return GetRecordCounterID('WithdrawlNo');
	}
				if($table=="ClientCashWithdrawl" && $field=="WithdrawlNo" && $ptype=="add")
	{
		return GetRecordCounterID('WithdrawlNo');
	}
				if($table=="ClientCashWithdrawl" && $field=="WithdrawlNo" && $ptype=="search")
	{
		return GetRecordCounterID('WithdrawlNo');
	}
				if($table=="ClientCashWithdrawl" && $field=="DateTime")
	{
		return now();
	}
				if($table=="ClientCashWithdrawl" && $field=="WithdrawlStatus" && $ptype=="add")
	{
		return "Pending";
	}
				if($table=="ClientCashWithdrawl" && $field=="LastModifiedBy")
	{
		return $_SESSION["UserName"];
	}
				if($table=="ClientCashWithdrawl" && $field=="LastModifiedDate")
	{
		return now();
	}
				if($table=="ClientLoanCredit" && $field=="LoanCreditPaymentNo" && $ptype=="edit")
	{
		return GetRecordCounterID('LoanCreditPaymentNo');
	}
				if($table=="ClientLoanCredit" && $field=="LoanCreditPaymentNo" && $ptype=="add")
	{
		return GetRecordCounterID('LoanCreditPaymentNo');
	}
				if($table=="ClientLoanCredit" && $field=="LoanCreditPaymentNo" && $ptype=="search")
	{
		return GetRecordCounterID('LoanCreditPaymentNo');
	}
				if($table=="ClientLoanCredit" && $field=="DateTime")
	{
		return now();
	}
				if($table=="ClientLoanCredit" && $field=="LoanCreditApplicationStatus" && $ptype=="add")
	{
		return "Pending";
	}
				if($table=="ClientLoanCredit" && $field=="LastModifiedBy")
	{
		return $_SESSION["UserName"];
	}
				if($table=="ClientLoanCredit" && $field=="LastModifiedDate")
	{
		return now();
	}
				if($table=="ClientSavingsAccounts" && $field=="AccountBalance")
	{
		return 0;
	}
				if($table=="ClientSavingsAccounts" && $field=="OpeningBalance")
	{
		return 0;
	}
				if($table=="ClientSavingsAccounts" && $field=="InterestRate")
	{
		return 0;
	}
				if($table=="ClientSavingsAccounts" && $field=="LastModifiedBy")
	{
		return $_SESSION["UserName"];
	}
				if($table=="ClientSavingsAccounts" && $field=="LastModifiedDate")
	{
		return now();
	}
				if($table=="ClientLoanAccounts" && $field=="AccountBalance")
	{
		return 0;
	}
				if($table=="ClientLoanAccounts" && $field=="OpeningBalance")
	{
		return 0;
	}
				if($table=="ClientLoanAccounts" && $field=="InterestRate")
	{
		return 0;
	}
				if($table=="ClientLoanAccounts" && $field=="LastModifiedBy")
	{
		return $_SESSION["UserName"];
	}
				if($table=="ClientLoanAccounts" && $field=="LastModifiedDate")
	{
		return now();
	}
				if($table=="SavingsAccounts" && $field=="AccountNumber" && $ptype=="edit")
	{
		return GetRecordCounterID('SavingAccountNumber');
	}
				if($table=="SavingsAccounts" && $field=="AccountNumber" && $ptype=="add")
	{
		return GetRecordCounterID('SavingsAccountNumber');
	}
				if($table=="SavingsAccounts" && $field=="AccountBalance" && $ptype=="edit")
	{
		return 0;
	}
				if($table=="SavingsAccounts" && $field=="AccountBalance" && $ptype=="add")
	{
		return 0;
	}
				if($table=="SavingsAccounts" && $field=="AccountBalance" && $ptype=="search")
	{
		return 0;
	}
				if($table=="SavingsAccounts" && $field=="LastTransactionDate")
	{
		return now();
	}
				if($table=="SavingsAccounts" && $field=="OpeningBalance")
	{
		return 0;
	}
				if($table=="SavingsAccounts" && $field=="InterestRate")
	{
		return 0;
	}
				if($table=="SavingsAccounts" && $field=="AccountType")
	{
		return 'Savings';
	}
				if($table=="SavingsAccounts" && $field=="LastModifiedBy")
	{
		return $_SESSION["UserName"];
	}
				if($table=="SavingsAccounts" && $field=="LastModifiedDate")
	{
		return now();
	}
				if($table=="usersLookupFiltered" && $field=="ClientNo" && $ptype=="add")
	{
		return GetRecordCounterID('ClientNo');
	}
				if($table=="usersLookupFiltered" && $field=="LastModifiedBy")
	{
		return $_SESSION["UserName"];
	}
				if($table=="usersLookupFiltered" && $field=="LastModifiedDate")
	{
		return now();
	}
				if($table=="accountsLookUpFiltered" && $field=="AccountBalance")
	{
		return 0;
	}
				if($table=="accountsLookUpFiltered" && $field=="OpeningBalance")
	{
		return 0;
	}
				if($table=="accountsLookUpFiltered" && $field=="InterestRate")
	{
		return 0;
	}
				if($table=="admin_members" && $field=="ClientNo" && $ptype=="add")
	{
		return GetRecordCounterID('ClientNo');
	}
				if($table=="admin_members" && $field=="LastModifiedBy")
	{
		return $_SESSION["UserName"];
	}
				if($table=="admin_members" && $field=="LastModifiedDate")
	{
		return now();
	}
				if($table=="admin_users" && $field=="LastModifiedBy")
	{
		return $_SESSION["UserName"];
	}
				if($table=="admin_users" && $field=="LastModifiedDate")
	{
		return now();
	}
				if($table=="ClientAccounts" && $field=="ClientNo" && $ptype=="add")
	{
		return GetRecordCounterID('ClientNo');
	}
				if($table=="ClientAccounts" && $field=="AccountNumber" && $ptype=="edit")
	{
		return GetRecordCounterID('SavingsAccountNumber');
	}
				if($table=="ClientAccounts" && $field=="AccountNumber" && $ptype=="add")
	{
		return GetRecordCounterID('SavingsAccountNumber');
	}
				if($table=="ClientAccounts" && $field=="OpeningAccountDate")
	{
		return now();
	}
				if($table=="ClientAccounts" && $field=="OpeningAccountBalance" && $ptype=="add")
	{
		return 0;
	}
				if($table=="ClientAccounts" && $field=="Password")
	{
		return "password";
	}
				if($table=="ClientAccounts" && $field=="UserLevel" && $ptype=="edit")
	{
		return "Client";
	}
				if($table=="ClientAccounts" && $field=="UserLevel" && $ptype=="add")
				...
				if($table=="ClientAccounts" && $field=="UserLevel" && $ptype=="search")
	{
		return "Client";
				...
				if($table=="ClientAccounts" && $field=="LastModifiedBy")
	{
		return $_SESSION["UserName"];
	}
				if($table=="ClientAccounts" && $field=="LastModifiedDate")
	{
		return now();
	}
				if($table=="loan" && $field=="LoanID")
	{
		return GetRecordCounterID('LoanID');
	}
	return "";
}
