...
class tDAL
{
	var $tblfinanace_at_localhost__accounts;
	var $tblfinanace_at_localhost__finance_searches;
	var $tblfinanace_at_localhost__finance_uggroups;
	var $tblfinanace_at_localhost__finance_ugmembers;
	var $tblfinanace_at_localhost__finance_ugrights;
	var $tblfinanace_at_localhost__loan;
	var $tblfinanace_at_localhost__LookUps;
	var $tblfinanace_at_localhost__recordidcounter;
	var $tblfinanace_at_localhost__schedule;
	var $tblfinanace_at_localhost__transactions;
	var $tblfinanace_at_localhost__users;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "accounts", "varname" => "finanace_at_localhost__accounts", "altvarname" => "accounts", "connId" => "finanace_at_localhost", "schema" => "", "connName" => "khmerban_finance at localhost");
		$this->lstTables[] = array("name" => "finance_searches", "varname" => "finanace_at_localhost__finance_searches", "altvarname" => "finance_searches", "connId" => "finanace_at_localhost", "schema" => "", "connName" => "khmerban_finance at localhost");
		$this->lstTables[] = array("name" => "finance_uggroups", "varname" => "finanace_at_localhost__finance_uggroups", "altvarname" => "finance_uggroups", "connId" => "finanace_at_localhost", "schema" => "", "connName" => "khmerban_finance at localhost");
		$this->lstTables[] = array("name" => "finance_ugmembers", "varname" => "finanace_at_localhost__finance_ugmembers", "altvarname" => "finance_ugmembers", "connId" => "finanace_at_localhost", "schema" => "", "connName" => "khmerban_finance at localhost");
		$this->lstTables[] = array("name" => "finance_ugrights", "varname" => "finanace_at_localhost__finance_ugrights", "altvarname" => "finance_ugrights", "connId" => "finanace_at_localhost", "schema" => "", "connName" => "khmerban_finance at localhost");
		$this->lstTables[] = array("name" => "loan", "varname" => "finanace_at_localhost__loan", "altvarname" => "loan", "connId" => "finanace_at_localhost", "schema" => "", "connName" => "khmerban_finance at localhost");
		$this->lstTables[] = array("name" => "LookUps", "varname" => "finanace_at_localhost__LookUps", "altvarname" => "LookUps", "connId" => "finanace_at_localhost", "schema" => "", "connName" => "khmerban_finance at localhost");
		$this->lstTables[] = array("name" => "recordidcounter", "varname" => "finanace_at_localhost__recordidcounter", "altvarname" => "recordidcounter", "connId" => "finanace_at_localhost", "schema" => "", "connName" => "khmerban_finance at localhost");
		$this->lstTables[] = array("name" => "schedule", "varname" => "finanace_at_localhost__schedule", "altvarname" => "schedule", "connId" => "finanace_at_localhost", "schema" => "", "connName" => "khmerban_finance at localhost");
		$this->lstTables[] = array("name" => "transactions", "varname" => "finanace_at_localhost__transactions", "altvarname" => "transactions", "connId" => "finanace_at_localhost", "schema" => "", "connName" => "khmerban_finance at localhost");
		$this->lstTables[] = array("name" => "users", "varname" => "finanace_at_localhost__users", "altvarname" => "users", "connId" => "finanace_at_localhost", "schema" => "", "connName" => "khmerban_finance at localhost");
	}
