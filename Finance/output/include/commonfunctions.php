...
function checkTableName($shortTName, $type=false)
{
	...
	if ("transactions" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("accounts" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("users" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("LookUps" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("usersLookUp" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("accountsLookUp" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("loanaccounts" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("CashDeposit" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("CashWithdrawl" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("LoanCredit" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("LoanPayment" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("SavingsStatements" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("LoanStatements" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("MonthlyBalanceSheet" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("BalaceEnquiry" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("NEFTTransfer" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("recordidcounter" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("YearlyBalanceSheet" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("TransactionLog" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("ClientCashWithdrawl" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("ClientLoanCredit" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("ClientSavingsAccounts" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("ClientLoanAccounts" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("SavingsAccounts" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("MonthlyStatement" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("YearlyStatement" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("usersLookupFiltered" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("accountsLookUpFiltered" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	...
	if ("admin_users" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("ClientAccounts" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("schedule" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("loan" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	return false;
}
...
{
	$arr = array();
	$strPerm = GetUserPermissions("transactions");
	...
	$strPerm = GetUserPermissions("LookUps");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="LookUps";
	}
	$strPerm = GetUserPermissions("usersLookUp");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="usersLookUp";
	}
	$strPerm = GetUserPermissions("accountsLookUp");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="accountsLookUp";
	}
	$strPerm = GetUserPermissions("loanaccounts");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="loanaccounts";
	}
	$strPerm = GetUserPermissions("CashDeposit");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="CashDeposit";
	}
	$strPerm = GetUserPermissions("CashWithdrawl");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="CashWithdrawl";
	}
	$strPerm = GetUserPermissions("LoanCredit");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="LoanCredit";
	}
	$strPerm = GetUserPermissions("LoanPayment");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="LoanPayment";
	}
	$strPerm = GetUserPermissions("SavingsStatements");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="SavingsStatements";
	}
	$strPerm = GetUserPermissions("LoanStatements");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="LoanStatements";
	}
	$strPerm = GetUserPermissions("MonthlyBalanceSheet");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="MonthlyBalanceSheet";
	}
	$strPerm = GetUserPermissions("BalaceEnquiry");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="BalaceEnquiry";
	}
	$strPerm = GetUserPermissions("NEFTTransfer");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="NEFTTransfer";
	}
	$strPerm = GetUserPermissions("recordidcounter");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="recordidcounter";
	}
	$strPerm = GetUserPermissions("YearlyBalanceSheet");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="YearlyBalanceSheet";
	}
	$strPerm = GetUserPermissions("TransactionLog");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="TransactionLog";
	}
	$strPerm = GetUserPermissions("ClientCashWithdrawl");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="ClientCashWithdrawl";
	}
	$strPerm = GetUserPermissions("ClientLoanCredit");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="ClientLoanCredit";
	}
	$strPerm = GetUserPermissions("ClientSavingsAccounts");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="ClientSavingsAccounts";
	}
	$strPerm = GetUserPermissions("ClientLoanAccounts");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="ClientLoanAccounts";
	}
	$strPerm = GetUserPermissions("SavingsAccounts");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="SavingsAccounts";
	}
	$strPerm = GetUserPermissions("MonthlyStatement");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="MonthlyStatement";
	}
	$strPerm = GetUserPermissions("YearlyStatement");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="YearlyStatement";
	}
	$strPerm = GetUserPermissions("usersLookupFiltered");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="usersLookupFiltered";
	}
	$strPerm = GetUserPermissions("accountsLookUpFiltered");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="accountsLookUpFiltered";
	}
	...
	$strPerm = GetUserPermissions("ClientAccounts");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="ClientAccounts";
	}
	$strPerm = GetUserPermissions("schedule");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="schedule";
	}
...
function ReadUserPermissions($userID = "")
{
	...
	if($userID != "Guest")
	{
		...
		$sql = "select ".$gConn->addFieldWrappers( "GroupID" )
			...
			." from ". $gConn->addTableWrappers( "finance_ugmembers" )
	...
	$sql = "select ". $gConn->addFieldWrappers( "TableName" )
		...
		." from ". $gConn->addTableWrappers( "finance_ugrights" )
...
{
	global $globalEvents;
	$_SESSION["GroupID"] = $data["AttachedFile"];


		$_SESSION["OwnerID"] = $data["ClientNo"];
	$_SESSION["_accounts_OwnerID"] = $data["ClientNo"];
		$_SESSION["_users_OwnerID"] = $data["AccountName"];
		$_SESSION["_usersLookUp_OwnerID"] = $data["AccountName"];
		$_SESSION["_NEFTTransfer_OwnerID"] = $data["ClientNo"];
		$_SESSION["_TransactionLog_OwnerID"] = $data["ClientNo"];
		$_SESSION["_ClientCashWithdrawl_OwnerID"] = $data["ClientNo"];
		$_SESSION["_ClientLoanCredit_OwnerID"] = $data["ClientNo"];
		$_SESSION["_ClientSavingsAccounts_OwnerID"] = $data["ClientNo"];
		$_SESSION["_ClientLoanAccounts_OwnerID"] = $data["ClientNo"];
		$_SESSION["_MonthlyStatement_OwnerID"] = $data["ClientNo"];
		$_SESSION["_YearlyStatement_OwnerID"] = $data["ClientNo"];
		$_SESSION["_usersLookupFiltered_OwnerID"] = $data["ClientNo"];
		$_SESSION["_accountsLookUpFiltered_OwnerID"] = $data["ClientNo"];
		$_SESSION["_admin_members_OwnerID"] = $data["AccountName"];
		$_SESSION["_admin_users_OwnerID"] = $data["AccountName"];
...
function CheckSecurity($strValue, $strAction, $table = "")
{
	...
	if( strpos($strPerm, "M") === false )
	{
		...
		if($table=="NEFTTransfer")
		{

				if(!($pSet->getCaseSensitiveUsername((string)$_SESSION["_".$table."_OwnerID"])===$pSet->getCaseSensitiveUsername((string)$strValue)))
				return false;
		}
		if($table=="TransactionLog")
		{

				if(!($pSet->getCaseSensitiveUsername((string)$_SESSION["_".$table."_OwnerID"])===$pSet->getCaseSensitiveUsername((string)$strValue)))
				return false;
		}
		if($table=="ClientCashWithdrawl")
		{

				if(!($pSet->getCaseSensitiveUsername((string)$_SESSION["_".$table."_OwnerID"])===$pSet->getCaseSensitiveUsername((string)$strValue)))
				return false;
		}
		if($table=="ClientLoanCredit")
		{

				if(!($pSet->getCaseSensitiveUsername((string)$_SESSION["_".$table."_OwnerID"])===$pSet->getCaseSensitiveUsername((string)$strValue)))
				return false;
		}
		if($table=="ClientSavingsAccounts")
		{

				if(!($pSet->getCaseSensitiveUsername((string)$_SESSION["_".$table."_OwnerID"])===$pSet->getCaseSensitiveUsername((string)$strValue)))
				return false;
		}
		if($table=="ClientLoanAccounts")
		{

				if(!($pSet->getCaseSensitiveUsername((string)$_SESSION["_".$table."_OwnerID"])===$pSet->getCaseSensitiveUsername((string)$strValue)))
				return false;
		}
		if($table=="MonthlyStatement")
		{

				if(!($pSet->getCaseSensitiveUsername((string)$_SESSION["_".$table."_OwnerID"])===$pSet->getCaseSensitiveUsername((string)$strValue)))
				return false;
		}
		if($table=="YearlyStatement")
		{

				if(!($pSet->getCaseSensitiveUsername((string)$_SESSION["_".$table."_OwnerID"])===$pSet->getCaseSensitiveUsername((string)$strValue)))
				return false;
		}
		if($table=="usersLookupFiltered")
		{

				if(!($pSet->getCaseSensitiveUsername((string)$_SESSION["_".$table."_OwnerID"])===$pSet->getCaseSensitiveUsername((string)$strValue)))
				return false;
		}
		if($table=="accountsLookUpFiltered")
		{
