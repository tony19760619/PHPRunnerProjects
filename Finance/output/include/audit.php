...
class AuditTrailTable
{
	...
	function logValueEnable($table)
	{
		...
		if($table=="usersLookUp")
		{
			return false;
		}
		if($table=="accountsLookUp")
		{
			return false;
		}
		if($table=="loanaccounts")
		{
			return false;
		}
		if($table=="CashDeposit")
		{
			return false;
		}
		if($table=="CashWithdrawl")
		{
			return false;
		}
		if($table=="LoanCredit")
		...
		if($table=="LoanPayment")
		{
			return false;
		}
		if($table=="SavingsStatements")
		{
			return false;
		}
		if($table=="LoanStatements")
		{
			return false;
		}
		if($table=="MonthlyBalanceSheet")
		{
			return false;
		}
		if($table=="BalaceEnquiry")
		{
			return false;
		}
		...
		if($table=="recordidcounter")
		{
			return false;
		}
		if($table=="YearlyBalanceSheet")
		{
			return false;
		}
