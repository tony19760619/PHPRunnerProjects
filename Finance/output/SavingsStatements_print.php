...
require_once("include/SavingsStatements_variables.php");
...
$page_layouts["SavingsStatements_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "SavingsStatements" );
