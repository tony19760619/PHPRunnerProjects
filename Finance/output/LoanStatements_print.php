...
require_once("include/LoanStatements_variables.php");
...
$page_layouts["LoanStatements_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "LoanStatements" );
