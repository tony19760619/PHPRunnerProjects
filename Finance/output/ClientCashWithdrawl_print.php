...
require_once("include/ClientCashWithdrawl_variables.php");
...
$page_layouts["ClientCashWithdrawl_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "ClientCashWithdrawl" );
