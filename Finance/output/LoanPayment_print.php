...
require_once("include/LoanPayment_variables.php");
...
$page_layouts["LoanPayment_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "LoanPayment" );
