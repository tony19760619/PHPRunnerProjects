...
require_once("include/MonthlyBalanceSheet_variables.php");
...
$page_layouts["MonthlyBalanceSheet_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "MonthlyBalanceSheet" );
