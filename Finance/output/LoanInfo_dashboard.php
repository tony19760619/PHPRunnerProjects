...
require_once("include/LoanInfo_variables.php");
...
$layout = new TLayout("dashboard", "RoundedOffice", "MobileOffice");
$layout->version = 2;
...
$page_layouts["LoanInfo_dashboard"] = $layout;
...
$params["templatefile"] = GetTemplateName("LoanInfo", "dashboard");
