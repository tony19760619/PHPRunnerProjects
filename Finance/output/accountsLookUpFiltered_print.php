...
require_once("include/accountsLookUpFiltered_variables.php");
...
$layout = new TLayout("print", "RoundedOffice", "MobileOffice");
$layout->version = 2;
...
$page_layouts["accountsLookUpFiltered_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "accountsLookUpFiltered" );
