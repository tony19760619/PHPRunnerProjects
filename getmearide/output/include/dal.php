...
class tDAL
{
	var $tblgetmearide_db_at_localhost__countries;
	var $tblgetmearide_db_at_localhost__findaride;
	var $tblgetmearide_db_at_localhost__findaridemessages;
	var $tblgetmearide_db_at_localhost__lookups;
	var $tblgetmearide_db_at_localhost__offeraride;
	var $tblgetmearide_db_at_localhost__offeraridemessages;
	var $tblgetmearide_db_at_localhost__users;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "countries", "varname" => "getmearide_db_at_localhost__countries", "altvarname" => "countries", "connId" => "getmearide_db_at_localhost", "schema" => "", "connName" => "transport_db at localhost");
		$this->lstTables[] = array("name" => "findaride", "varname" => "getmearide_db_at_localhost__findaride", "altvarname" => "findaride", "connId" => "getmearide_db_at_localhost", "schema" => "", "connName" => "transport_db at localhost");
		$this->lstTables[] = array("name" => "findaridemessages", "varname" => "getmearide_db_at_localhost__findaridemessages", "altvarname" => "findaridemessages", "connId" => "getmearide_db_at_localhost", "schema" => "", "connName" => "transport_db at localhost");
		$this->lstTables[] = array("name" => "lookups", "varname" => "getmearide_db_at_localhost__lookups", "altvarname" => "lookups", "connId" => "getmearide_db_at_localhost", "schema" => "", "connName" => "transport_db at localhost");
		$this->lstTables[] = array("name" => "offeraride", "varname" => "getmearide_db_at_localhost__offeraride", "altvarname" => "offeraride", "connId" => "getmearide_db_at_localhost", "schema" => "", "connName" => "transport_db at localhost");
		$this->lstTables[] = array("name" => "offeraridemessages", "varname" => "getmearide_db_at_localhost__offeraridemessages", "altvarname" => "offeraridemessages", "connId" => "getmearide_db_at_localhost", "schema" => "", "connName" => "transport_db at localhost");
		$this->lstTables[] = array("name" => "users", "varname" => "getmearide_db_at_localhost__users", "altvarname" => "users", "connId" => "getmearide_db_at_localhost", "schema" => "", "connName" => "transport_db at localhost");
	}
