...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "offeraride" ] = array( "url" => "offeraride", "type" => 0 );
	$projectEntitiesReverse[ "offeraride" ] = "offeraride";
	$projectEntities[ "offeraridemessages" ] = array( "url" => "offeraridemessages", "type" => 0 );
	$projectEntitiesReverse[ "offeraridemessages" ] = "offeraridemessages";
	$projectEntities[ "findaridemessages" ] = array( "url" => "findaridemessages", "type" => 0 );
	$projectEntitiesReverse[ "findaridemessages" ] = "findaridemessages";
	...
	$projectEntities[ "findaride" ] = array( "url" => "findaride", "type" => 0 );
	$projectEntitiesReverse[ "findaride" ] = "findaride";
	$projectEntities[ "countries" ] = array( "url" => "countries", "type" => 0 );
	$projectEntitiesReverse[ "countries" ] = "countries";
