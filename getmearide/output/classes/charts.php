...
class Chart
{
	...
	protected function isProjectDB()
	{
		...
		if("offeraride" == $this->chrt_array['tables'][0])
			return true;
		if("offeraridemessages" == $this->chrt_array['tables'][0])
			return true;
		if("findaridemessages" == $this->chrt_array['tables'][0])
			return true;
		if("lookups" == $this->chrt_array['tables'][0])
			return true;
		if("users" == $this->chrt_array['tables'][0])
			return true;
		if("findaride" == $this->chrt_array['tables'][0])
			return true;
		if("countries" == $this->chrt_array['tables'][0])
			return true;
		if("users" == $this->chrt_array['tables'][0])
			return true;
		return false;
