...
class ConnectionManager
{
	...
	{
		return $this->byId( "getmearide_db_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "getmearide_db_at_localhost";
		$data["connName"] = "transport_db at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;transport_db;;1"; //currently unused
		
		$this->_connectionsIdByName["transport_db at localhost"] = "getmearide_db_at_localhost";
		...
		$data["connInfo"][2] = "";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "transport_db";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=transport_db;OPTION=3";
		// encription set
		...
		$connectionsData["getmearide_db_at_localhost"] = $data;
	...
	protected function _setTablesConnectionIds()
	{
		...
		$connectionsIds["offeraride"] = "getmearide_db_at_localhost";
		$connectionsIds["offeraridemessages"] = "getmearide_db_at_localhost";
		$connectionsIds["findaridemessages"] = "getmearide_db_at_localhost";
		$connectionsIds["lookups"] = "getmearide_db_at_localhost";
		$connectionsIds["users"] = "getmearide_db_at_localhost";
		$connectionsIds["findaride"] = "getmearide_db_at_localhost";
		$connectionsIds["countries"] = "getmearide_db_at_localhost";
		$connectionsIds["admin_users"] = "getmearide_db_at_localhost";
