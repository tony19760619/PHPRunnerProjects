...
require_once("include/wantedrides_variables.php");
...
$page_layouts["wantedrides_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "wantedrides" );
