...
require_once("include/availablerides_variables.php");
...
$page_layouts["availablerides_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "availablerides" );
