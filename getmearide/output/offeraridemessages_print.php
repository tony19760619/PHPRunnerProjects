...
$layout = new TLayout("print", "OfficeOffice", "MobileOffice");
$layout->version = 2;
...
$page_layouts["offeraridemessages_print"] = $layout;
...
$page_layouts["offeraride_masterprint"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "offeraridemessages" );
