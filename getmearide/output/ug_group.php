...
$nonAdminTablesArr[] = "offeraride";
$nonAdminTablesArr[] = "findaride";
$nonAdminTablesArr[] = "lookups";
$nonAdminTablesArr[] = "users";
$nonAdminTablesArr[] = "offeraridemessages";
$nonAdminTablesArr[] = "findaridemessages";
...
$wGroupTableName = $ug_connection->addTableWrappers( "getmearide_uggroups" );
...
switch(postvalue("a"))
{
	...
	case "del":
		...
		$sql = "delete from ". $ug_connection->addTableWrappers( "getmearide_ugrights" ) 
			." where ". $ug_connection->addFieldWrappers( "GroupID" ) ."=".(postvalue("id")+0);
		$ug_connection->exec( $sql );
		
		$sql = "delete from ".$ug_connection->addTableWrappers( "getmearide_ugmembers" ) 
			." where ". $ug_connection->addFieldWrappers( "GroupID" ) ."=".(postvalue("id")+0);
		$ug_connection->exec( $sql );
	...
	case 'saveRights':
		...
		{	
			...
			$wRightsTableName = $ug_connection->addTableWrappers( "getmearide_ugrights" );
	...
	case 'saveMembership':
		...
		$wMemebersTableName = $ug_connection->addTableWrappers( "getmearide_ugmembers" );
