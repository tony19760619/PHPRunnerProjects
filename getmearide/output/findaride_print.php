...
require_once("include/findaride_variables.php");
...
$page_layouts["findaride_print"] = $layout;
...
$layout->blocks["top"][] = "master";
$page_layouts["findaridemessages_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "findaride" );
