...
require_once("include/offeraride_variables.php");
...
$page_layouts["offeraride_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "offeraride" );
