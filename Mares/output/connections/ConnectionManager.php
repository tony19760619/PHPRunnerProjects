...
class ConnectionManager
{
	...
	{
		return $this->byId( "mares_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "mares_at_localhost";
		$data["connName"] = "la21jrus_mares at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;la21jrus_mares;mares!23!;;la21jrus_mares;;1"; //currently unused
		
		$this->_connectionsIdByName["la21jrus_mares at localhost"] = "mares_at_localhost";
		
		$data["connInfo"] = array();
		$data["ODBCUID"] = "la21jrus_mares";
		$data["ODBCPWD"] = "mares!23!";
		$data["leftWrap"] = "`";
		$data["rightWrap"] = "`";
...
;
		...
		$connectionsData["mares_at_localhost"] = $data;
	...
	protected function _setTablesConnectionIds()
	{
		...
		$connectionsIds["cidades"] = "mares_at_localhost";
		$connectionsIds["chart"] = "mares_at_localhost";
		$connectionsIds["mares"] = "mares_at_localhost";
