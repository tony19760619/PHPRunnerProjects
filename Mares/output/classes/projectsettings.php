...
function fillProjectEntites()
{
	...
	$projectEntities[ "chart" ] = array( "url" => "chart", "type" => 0 );
	$projectEntitiesReverse[ "chart" ] = "chart";
	$projectEntities[ "mares" ] = array( "url" => "mares", "type" => 0 );
	$projectEntitiesReverse[ "mares" ] = "mares";
}
