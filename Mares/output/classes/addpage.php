...
class AddPage extends RunnerPage
{
	...
	protected function setSuccessfulUpdateMessage()
	{
		...
		if( $this->mode == ADD_INLINE ) 
			$infoMessage = ""."O registo foi adicionado"."";
		else
			$infoMessage = "<strong><<< "."O registo foi adicionado"." >>></strong>";
	...
	public function setDatabaseError( $message )
	{
		if( $this->mode != ADD_INLINE )
		{
			$this->message = "<strong>&lt;&lt;&lt; "."O Registo NÃO foi adicionado"."</strong> &gt;&gt;&gt;<br><br>".$message;
		}
		else
		{
			$this->message = "O Registo NÃO foi adicionado".". ".$message;
		}
