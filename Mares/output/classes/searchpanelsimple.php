...
class SearchPanelSimple extends SearchPanel {
	...
	{	
		...
		$searchOpt_mess = ($searchPanelAttrs['srchOptShowStatus'] ? "Esconder opções de pesquisa" : "Mostrar opções de pesquisa");
		...
		$searchforAttrs.= ' placeholder="'."pesquisar".'"';
	...
	function DisplaySearchPanel()
	{
		...
		$showHideOpt_mess = $this->srchPanelAttrs['ctrlTypeComboStatus'] ? "Esconder opções" : "Mostrar opções";		
