...
{	
	...
	function addCommonHtml() 
	{
		...
		if($this->is508) {
			$this->body["begin"].= "<a href=\"#skipdata\" title=\""."Passar para a tabela de dados"."\" class=\"".$this->makeClassName("s508")."\">"."Passar para a tabela de dados"."</a>";
			$this->body["begin"].= "<a href=\"#skipmenu\" title=\""."Passar para o menu"."\" class=\"".$this->makeClassName("s508")."\">"."Passar para o menu"."</a>";
			$this->body["begin"].= "<a href=\"#skipsearch\" title=\""."Passar para a procura"."\" class=\"".$this->makeClassName("s508")."\">"."Passar para a procura"."</a>";
			$this->body["begin"].= "<a href=\"templates/helpshortcut.htm\" title=\""."Teclas de atalho"."\" class=\"".$this->makeClassName("s508")."\">"."Teclas de atalho"."</a>";
		}
