...
class EditControl
{
	...
	function __construct($field, $pageObject, $id, $connection)
	{
		...
		$this->searchOptions[STARTS_WITH] = "Inicia por";
		...
		$this->searchOptions[NOT_CONTAINS] = "Não contêm";
		$this->searchOptions[NOT_EQUALS] = "Não é igual a";
		$this->searchOptions[NOT_STARTS_WITH] = "Não inicia por";
		$this->searchOptions[NOT_MORE_THAN] = "Não é maior do que";
		$this->searchOptions[NOT_LESS_THAN] = "Não é menor que";
		$this->searchOptions[NOT_BETWEEN] = "Não está entre";
		$this->searchOptions[NOT_EMPTY] = "Não está vazio";
