...
class tDAL
{
	var $tblmares_at_localhost__chart;
	var $tblmares_at_localhost__cidades;
	var $tblmares_at_localhost__mares;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "chart", "varname" => "mares_at_localhost__chart", "altvarname" => "chart", "connId" => "mares_at_localhost", "schema" => "", "connName" => "la21jrus_mares at localhost");
		$this->lstTables[] = array("name" => "cidades", "varname" => "mares_at_localhost__cidades", "altvarname" => "cidades", "connId" => "mares_at_localhost", "schema" => "", "connName" => "la21jrus_mares at localhost");
		$this->lstTables[] = array("name" => "mares", "varname" => "mares_at_localhost__mares", "altvarname" => "mares", "connId" => "mares_at_localhost", "schema" => "", "connName" => "la21jrus_mares at localhost");
	}
