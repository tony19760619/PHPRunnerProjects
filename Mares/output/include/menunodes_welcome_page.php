...
function getMenuNodes_welcome_page($menuNodesObject)
{
	...
	$menuNode["title"] = "Cidades";

	$menuNode["comments"] = "Cidades description";
	...
	$menuNode["title"] = "Chart";

	$menuNode["comments"] = "Chart description";
	...
	$menuNode["comments"] = "Mares description";
